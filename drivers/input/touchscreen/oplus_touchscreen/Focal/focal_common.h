...
enum limit_type {
	...
	LIMIT_TYPE_TX_RX_DATA =
		0x03, //means all nodes have it's own limit,format is : tx * rx,horizontal for rx data,vertical for tx data
	LIMIT_TYPE_SLEF_TX_RX_DATA =
		0x04, //means all nodes have it's own limit,format is : tx + rx
	LIMIT_TYPE_SLEF_TX_RX_DATA_DOUBLE =
		0x05, //means all nodes have it's own limit,format is : tx + tx + rx + rx
	/***************************** Novatek *********************************/
	LIMIT_TYPE_TOP_FLOOR_DATA =
		0x06, //means all nodes limit data is a certain data
	LIMIT_TYPE_DOZE_FDM_DATA =
		0x07, //means all nodes limit data is a certain data
	LIMIT_TYPE_TOP_FLOOR_RX_TX_DATA =
		0x08, //means all nodes limit data is a certain data
