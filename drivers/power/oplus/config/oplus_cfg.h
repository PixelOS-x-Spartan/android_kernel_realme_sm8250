...
static inline struct oplus_cfg_data_head *oplus_cfg_find_param_by_name(struct oplus_param_head *param_head,
								       const char *name)
{
	return NULL;
}

static inline ssize_t oplus_cfg_get_data_size(struct oplus_cfg_data_head *data_head)
{
	return 0;
}

static inline int oplus_cfg_get_data(struct oplus_cfg_data_head *data_head, u8 *buf, size_t len)
{
	return 0;
}

static inline int oplus_cfg_get_data_by_name(struct oplus_param_head *param_head, const char *name, u8 *buf, size_t len)
{
	return 0;
}
