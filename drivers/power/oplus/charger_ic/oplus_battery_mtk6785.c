...
bool is_sala_a(void)
{
	...
	if (get_project() == PROJECT_SALA) {
		if (((operator_ver == OPERATOR_VER143) || (operator_ver == OPERATOR_VER144) ||
		     (operator_ver == OPERATOR_VER145) || (operator_ver == OPERATOR_VER147))) {
...
void oplus_get_usbtemp_volt(struct oplus_chg_chip *chip)
{
	...
	if (!pinfo->usb_temp_v_l_chan || !pinfo->usb_temp_v_r_chan) {
		chg_err("usb_temp_v_l_chan or usb_temp_v_r_chan NULL\n");
		return;
	}
