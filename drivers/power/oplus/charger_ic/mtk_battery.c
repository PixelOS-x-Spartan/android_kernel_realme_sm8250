...
static int adc_cali_slop[14] = { 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000 };
...
int gauge_enable_iavg_interrupt(bool ht_en, int ht_th, bool lt_en, int lt_th)
{
...
static void proc_dump_dtsi(struct seq_file *m)
{
	...
	seq_printf(m, "lbat: %d %d %d\n", fg_cust_data.vbat2_det_voltage1, fg_cust_data.vbat2_det_voltage2,
...
static void dump_kernel_table(struct seq_file *m)
{
	...
	for (i = 0; i < 100; i++) {
		seq_printf(m, "%d: %d %d %d %d\n", i, fg_table_cust_data.fg_profile_t0[i].mah,
			   fg_table_cust_data.fg_profile_t0[i].voltage, fg_table_cust_data.fg_profile_t0[i].resistance,
...
static ssize_t show_Battery_Temperature(struct device *dev, struct device_attribute *attr, char *buf)
{
#ifndef OPLUS_FEATURE_CHG_BASIC
...
static ssize_t store_Battery_Temperature(struct device *dev, struct device_attribute *attr, const char *buf,
					 size_t size)
{
	signed int temp;
...
static DEVICE_ATTR(Battery_Temperature, 0664, show_Battery_Temperature, store_Battery_Temperature);
...
void fgauge_get_profile_id(void)
{
	...
	bm_err("[fgauge_get_profile_id]Battery id=(%d) en:%d,%d\n", g_fg_battery_id, Bat_EC_ctrl.debug_bat_id_en,
	       Bat_EC_ctrl.debug_bat_id_value);
}
#endif
...
/* ADC resistor  */
	...
	memcpy(&fg_table_cust_data.fg_profile_t0, &fg_profile_t0[g_fg_battery_id],
	...
	memcpy(&fg_table_cust_data.fg_profile_t1, &fg_profile_t1[g_fg_battery_id],
	...
	memcpy(&fg_table_cust_data.fg_profile_t2, &fg_profile_t2[g_fg_battery_id],
	...
	memcpy(&fg_table_cust_data.fg_profile_t3, &fg_profile_t3[g_fg_battery_id],
	...
	memcpy(&fg_table_cust_data.fg_profile_t4, &fg_profile_t4[g_fg_battery_id],
...
#ifdef CONFIG_OF
static void fg_custom_parse_table(const struct device_node *np, const char *node_srting,
...
void fg_custom_init_from_dts(struct platform_device *dev)
{
	...
	switch (bat_id) {
	case 0:
		fg_custom_parse_table(np, "battery0_profile_t0", fg_table_cust_data.fg_profile_t0);
		fg_custom_parse_table(np, "battery0_profile_t1", fg_table_cust_data.fg_profile_t1);
		fg_custom_parse_table(np, "battery0_profile_t2", fg_table_cust_data.fg_profile_t2);
		fg_custom_parse_table(np, "battery0_profile_t3", fg_table_cust_data.fg_profile_t3);
#ifdef CONFIG_MTK_ADDITIONAL_BATTERY_TABLE
		fg_custom_parse_table(np, "battery0_profile_t4", fg_table_cust_data.fg_profile_t4);
#endif
		break;

	case 1:
		fg_custom_parse_table(np, "battery1_profile_t0", fg_table_cust_data.fg_profile_t0);
		fg_custom_parse_table(np, "battery1_profile_t1", fg_table_cust_data.fg_profile_t1);
		fg_custom_parse_table(np, "battery1_profile_t2", fg_table_cust_data.fg_profile_t2);
		fg_custom_parse_table(np, "battery1_profile_t3", fg_table_cust_data.fg_profile_t3);
#ifdef CONFIG_MTK_ADDITIONAL_BATTERY_TABLE
		fg_custom_parse_table(np, "battery1_profile_t4", fg_table_cust_data.fg_profile_t4);
#endif
		break;

	case 2:
		fg_custom_parse_table(np, "battery2_profile_t0", fg_table_cust_data.fg_profile_t0);
		fg_custom_parse_table(np, "battery2_profile_t1", fg_table_cust_data.fg_profile_t1);
		fg_custom_parse_table(np, "battery2_profile_t2", fg_table_cust_data.fg_profile_t2);
		fg_custom_parse_table(np, "battery2_profile_t3", fg_table_cust_data.fg_profile_t3);
#ifdef CONFIG_MTK_ADDITIONAL_BATTERY_TABLE
		fg_custom_parse_table(np, "battery2_profile_t4", fg_table_cust_data.fg_profile_t4);
#endif
		break;

	case 3:
		fg_custom_parse_table(np, "battery3_profile_t0", fg_table_cust_data.fg_profile_t0);
		fg_custom_parse_table(np, "battery3_profile_t1", fg_table_cust_data.fg_profile_t1);
		fg_custom_parse_table(np, "battery3_profile_t2", fg_table_cust_data.fg_profile_t2);
		fg_custom_parse_table(np, "battery3_profile_t3", fg_table_cust_data.fg_profile_t3);
#ifdef CONFIG_MTK_ADDITIONAL_BATTERY_TABLE
		fg_custom_parse_table(np, "battery3_profile_t4", fg_table_cust_data.fg_profile_t4);
#endif
		break;
	case 6:
		fg_custom_parse_table(np, "battery6_profile_t0", fg_table_cust_data.fg_profile_t0);
		fg_custom_parse_table(np, "battery6_profile_t1", fg_table_cust_data.fg_profile_t1);
		fg_custom_parse_table(np, "battery6_profile_t2", fg_table_cust_data.fg_profile_t2);
		fg_custom_parse_table(np, "battery6_profile_t3", fg_table_cust_data.fg_profile_t3);
#ifdef CONFIG_MTK_ADDITIONAL_BATTERY_TABLE
		fg_custom_parse_table(np, "battery6_profile_t4", fg_table_cust_data.fg_profile_t4);
#endif
		break;

	case 7:
		fg_custom_parse_table(np, "battery7_profile_t0", fg_table_cust_data.fg_profile_t0);
		fg_custom_parse_table(np, "battery7_profile_t1", fg_table_cust_data.fg_profile_t1);
		fg_custom_parse_table(np, "battery7_profile_t2", fg_table_cust_data.fg_profile_t2);
		fg_custom_parse_table(np, "battery7_profile_t3", fg_table_cust_data.fg_profile_t3);
#ifdef CONFIG_MTK_ADDITIONAL_BATTERY_TABLE
		fg_custom_parse_table(np, "battery7_profile_t4", fg_table_cust_data.fg_profile_t4);
#endif
		break;
	case 8:
		fg_custom_parse_table(np, "battery8_profile_t0", fg_table_cust_data.fg_profile_t0);
		fg_custom_parse_table(np, "battery8_profile_t1", fg_table_cust_data.fg_profile_t1);
		fg_custom_parse_table(np, "battery8_profile_t2", fg_table_cust_data.fg_profile_t2);
		fg_custom_parse_table(np, "battery8_profile_t3", fg_table_cust_data.fg_profile_t3);
#ifdef CONFIG_MTK_ADDITIONAL_BATTERY_TABLE
		fg_custom_parse_table(np, "battery8_profile_t4", fg_table_cust_data.fg_profile_t4);
#endif
		break;
	default:
		break;
...
void fg_custom_data_check(void)
{
	...
	bm_err("FGLOG pon_iboot[%d,%d,%d,%d,%d] qmax_sys_vol[%d %d %d %d %d]\n", p->pon_iboot_t0, p->pon_iboot_t1,
	       p->pon_iboot_t2, p->pon_iboot_t3, p->pon_iboot_t4, p->qmax_sys_vol_t0, p->qmax_sys_vol_t1,
	...
	if (update == true || pre_bat_temperature_val == -1) {
		...
		if (bat_temperature_volt != 0) {
			...
			if (fg_current_state == true) {
				...
				bat_temperature_volt = bat_temperature_volt -
						       ((fg_current_temp * (fg_meter_res_value + fg_r_value)) / 10000);
		...
		bm_notice("[force_get_tbat] %d,%d,%d,%d,%d,%d r:%d %d %d\n", bat_temperature_volt_temp,
			  bat_temperature_volt, fg_current_state, fg_current_temp, fg_r_value, bat_temperature_val,
		...
		if (pre_bat_temperature_val2 == 0) {
			...
			if (((dtime.tv_sec <= 20) && (abs(pre_bat_temperature_val2 - bat_temperature_val) >= 5)) ||
				...
				bm_notice(
					"[force_get_tbat][err] current:%d,%d,%d,%d,%d,%d pre:%d,%d,%d,%d,%d,%d\n",
				       ...
				       fg_current_temp, fg_r_value, bat_temperature_val, pre_bat_temperature_volt_temp,
				       pre_bat_temperature_volt, pre_fg_current_state, pre_fg_current_temp,
				       pre_fg_r_value, pre_bat_temperature_val2);
				/*pmic_auxadc_debug(1);*/
#ifndef OPLUS_FEATURE_CHG_BASIC
				WARN_ON(1);
#endif /* OPLUS_FEATURE_CHG_BASIC */
			...
			bm_trace("[force_get_tbat] current:%d,%d,%d,%d,%d,%d pre:%d,%d,%d,%d,%d,%d time:%d\n",
				 ...
				 fg_r_value, bat_temperature_val, pre_bat_temperature_volt_temp,
				 pre_bat_temperature_volt, pre_fg_current_state, pre_fg_current_temp, pre_fg_r_value,
...
int get_customized_d0_c_soc(int origin_d0_c_soc)
{
	...
	bm_err("[get_customized_d0_c_soc] EC_en %d EC_value %d original %d val %d\n", Bat_EC_ctrl.debug_d0_c_en,
	       Bat_EC_ctrl.debug_d0_c_value, origin_d0_c_soc, val);
...
int get_customized_d0_v_soc(int origin_d0_v_soc)
{
	...
	bm_err("[get_customized_d0_c_soc] EC_en %d EC_value %d original %d val %d\n", Bat_EC_ctrl.debug_d0_v_en,
	       Bat_EC_ctrl.debug_d0_v_value, origin_d0_v_soc, val);
...
int get_customized_uisoc(int origin_uisoc)
{
	...
	bm_err("[get_customized_d0_c_soc] EC_en %d EC_value %d original %d val %d\n", Bat_EC_ctrl.debug_uisoc_en,
	       Bat_EC_ctrl.debug_uisoc_value, origin_uisoc, val);
...
/* CHR_NORMAL = 0 */
	...
	case FG_DAEMON_CMD_GET_CUSTOM_SETTING: {
		...
		memcpy(&ret_msg->fgd_data[ret_msg->fgd_data_len], &fg_table_cust_data, sizeof(fg_table_cust_data));
		ret_msg->fgd_data_len += sizeof(fg_table_cust_data);

		bm_debug("[fg_res] data len:%d %d custom data length = %d\n", (int)sizeof(fg_cust_data),
			 (int)sizeof(fg_table_cust_data), ret_msg->fgd_data_len);
	} break;
	...
	case FG_DAEMON_CMD_SET_KERNEL_SOC: {
		...
		if (soc_type == 4)
			bm_err("[fg_res] FG_DAEMON_CMD_SET_KERNEL_SOC = %d %d %d %d %d %d, type:%d\n", daemon_soc,
			       FG_status.soc, fg_cust_data.c_old_d0, fg_cust_data.v_old_d0, fg_cust_data.c_soc,
...
void fg_bat_temp_int_internal(void)
{
	...
	if (is_vooc_project()) {
		...
		bm_err("[fg_bat_temp_int_internal][FG_TEMP_INT] T[%d] V[%d %d] C[%d %d] h[%d %d]\n", tmp, fg_bat_tmp_ht,
		       fg_bat_tmp_lt, fg_bat_tmp_c_ht, fg_bat_tmp_c_lt, fg_bat_new_lt, fg_bat_new_ht);
	}
#else
#if defined(CONFIG_MTK_DISABLE_GAUGE) || defined(FIXED_TBAT_25)
#ifndef OPLUS_FEATURE_CHG_BASIC
...
void fg_update_sw_iavg(void)
{
	...
	if (diff.tv_sec >= 60) {
		...
		bm_debug("[fg_update_sw_iavg]time:%ld car:%d %d iavg:%d ht:%d lt:%d gap:%d\n", diff.tv_sec, fg_coulomb,
			 sw_iavg_car, sw_iavg, sw_iavg_ht, sw_iavg_lt, sw_iavg_gap);
	}
}
...
void fg_update_sw_low_battery_check(unsigned int thd)
{
	...
	bm_debug("[fg_update_sw_low_battery_check]vbat:%d ht:%d %d lt:%d %d\n", vbat, sw_low_battery_ht_en,
		 sw_low_battery_ht_threshold, sw_low_battery_lt_en, sw_low_battery_lt_threshold);
	mutex_lock(&sw_low_battery_mutex);
...
#endif
	       fg_coulomb, coulomb_plus.end, coulomb_minus.end, soc_plus.end, soc_minus.end, fg_current_state,
	       fg_current, bat_vol, chr_vol, battery_get_bat_soc(), battery_get_bat_uisoc(), gDisableGM30,
	       fg_cust_data.disable_nafg, ntc_disable_nafg, cmd_disable_nafg);
...
#else
	bm_notice(
		"tmp:%d %d %d hcar2:%d lcar2:%d time:%d sw_iavg:%d %d %d nafg_m:%d %d %d\n",
#endif
	       tmp, fg_bat_tmp_int_ht, fg_bat_tmp_int_lt, fg_bat_int2_ht, fg_bat_int2_lt, fg_get_system_sec(), sw_iavg,
	       fg_current_iavg, valid, last_nafg_cnt, is_nafg_broken, disable_nafg_int);
...
static ssize_t store_FG_daemon_disable(struct device *dev, struct device_attribute *attr, const char *buf, size_t size)
{
...
static ssize_t store_FG_meter_resistance(struct device *dev, struct device_attribute *attr, const char *buf,
					 size_t size)
{
	unsigned long val = 0;
	int ret;
...
static ssize_t store_FG_nafg_disable(struct device *dev, struct device_attribute *attr, const char *buf, size_t size)
{
	unsigned long val = 0;
	int ret;
...
static ssize_t store_uisoc_update_type(struct device *dev, struct device_attribute *attr, const char *buf, size_t size)
{
	unsigned long val = 0;
	int ret;
...
static ssize_t store_FG_daemon_log_level(struct device *dev, struct device_attribute *attr, const char *buf,
					 size_t size)
{
	unsigned long val = 0;
	int ret;
...
static ssize_t store_shutdown_cond_enable(struct device *dev, struct device_attribute *attr, const char *buf,
					  size_t size)
{
	unsigned long val = 0;
	int ret;
...
static ssize_t store_reset_battery_cycle(struct device *dev, struct device_attribute *attr, const char *buf,
					 size_t size)
{
	unsigned long val = 0;
	int ret;
...
static ssize_t store_FG_Battery_CurrentConsumption(struct device *dev, struct device_attribute *attr, const char *buf,
						   size_t size)
{
...
static long adc_cali_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	case ADC_CHANNEL_READ:
		...
		bm_notice("**** unlocked_ioctl : Channel %d * %d times = %d\n", adc_in_data[0], adc_in_data[1],
			  adc_out_data[0]);
		break;
...
static int mtk_usb_get_property(struct power_supply *psy, enum power_supply_property psp,
				union power_supply_propval *val)
{
	int ret = 0;
...
static int mtk_usb_property_is_writeable(struct power_supply *psy, enum power_supply_property psp)
{
	int ret = 0;
...
static int mtk_usb_set_property(struct power_supply *psy, enum power_supply_property psp,
...
static int mtk_ac_get_property(struct power_supply *psy, enum power_supply_property psp,
			       union power_supply_propval *val)
{
	int ret = 0;
...
static int mtk_battery_property_is_writeable(struct power_supply *psy, enum power_supply_property psp)
{
	int rc = 0;
...
static int mtk_battery_set_property(struct power_supply *psy, enum power_supply_property psp,
				    const union power_supply_propval *val)
{
	int ret = 0;
...
static int mtk_battery_get_property(struct power_supply *psy, enum power_supply_property psp,
				    union power_supply_propval *val)
{
	int ret = 0;
...
static int __init battery_probe(struct platform_device *dev)
{
	...
	chip = devm_kzalloc(&client->dev, sizeof(struct oplus_chg_chip), GFP_KERNEL);
	if (!chip) {
	...
	if (gauge_get_hw_version() >= GAUGE_HW_V1000) {
		...
		if (gauge_get_hw_version() < GAUGE_HW_V2000) {
			lbat_user_register(&lowbat_service, "fuel gauge", fg_cust_data.vbat2_det_voltage3 / 10,
					   fg_cust_data.vbat2_det_voltage1 / 10, fg_cust_data.vbat2_det_voltage2 / 10,
	...
	if (shutdown_time == NULL) {
		...
		bm_err(" shutdown_time = %s len %d shutdown_time_tmp %s pl_shutdown_time[%d]\n", shutdown_time,
		       shutdown_time_len, shutdown_time_tmp, pl_shutdown_time);
	}
...
#ifndef OPLUS_FEATURE_CHG_BASIC
	if (is_recovery_mode() && !is_project(OPLUS_17197) &&
	    (!is_project(OPLUS_18311) || (get_Operator_Version() == OPERATOR_18328_ASIA_SIMPLE_NORMALCHG))) {
...
static void get_average_current(struct work_struct *work)
{
	...
	queue_delayed_work(average_current_wq, &get_average_current_wk, msecs_to_jiffies(delay_time * 1000));
}
...
static int battery_type_check(void)
{
	...
	if (is_project(OPLUS_17331) || is_project(OPLUS_17061) || is_project(OPLUS_17175) ||
	    (get_Operator_Version() == OPERATOR_18328_ASIA_SIMPLE_NORMALCHG)) {
		g_fg_battery_id = 1;
...
try_again:
	...
	if (battery_type == BAT_TYPE__SDI_4400mV || battery_type == BAT_TYPE__LG_4400mV ||
	    battery_type == BAT_TYPE__ATL_4400mV) {
		return true;
	} else {
		if (retry_flag == 0) {
...
static int __init battery_init(void)
{
	...
	if (average_current_wq == NULL) {
		...
		queue_delayed_work(average_current_wq, &get_average_current_wk, msecs_to_jiffies(5 * 1000));
	}
#endif /* OPLUS_FEATURE_CHG_BASIC */
