...
static int bq2597x_enable_wdt(struct bq2597x *bq, bool enable)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_0B, BQ2597X_WATCHDOG_DIS_MASK, val);
	return ret;
}
...
static int bq2597x_set_batovp_th(struct bq2597x *bq, int threshold)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_00, BQ2597X_BAT_OVP_MASK, val);
	return ret;
}
...
static int bq2597x_enable_batovp_alarm(struct bq2597x *bq, bool enable)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_01, BQ2597X_BAT_OVP_ALM_DIS_MASK, val);
	return ret;
}
...
static int bq2597x_set_batovp_alarm_th(struct bq2597x *bq, int threshold)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_01, BQ2597X_BAT_OVP_ALM_MASK, val);
	return ret;
}
...
static int bq2597x_enable_batocp(struct bq2597x *bq, bool enable)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_02, BQ2597X_BAT_OCP_DIS_MASK, val);
	return ret;
}
...
static int bq2597x_set_batocp_th(struct bq2597x *bq, int threshold)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_02, BQ2597X_BAT_OCP_MASK, val);
	return ret;
}
...
static int bq2597x_enable_batocp_alarm(struct bq2597x *bq, bool enable)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_03, BQ2597X_BAT_OCP_ALM_DIS_MASK, val);
	return ret;
}
...
static int bq2597x_set_batocp_alarm_th(struct bq2597x *bq, int threshold)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_03, BQ2597X_BAT_OCP_ALM_MASK, val);
	return ret;
}
...
static int bq2597x_set_busovp_th(struct bq2597x *bq, int threshold)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_06, BQ2597X_BUS_OVP_MASK, val);
	return ret;
}
...
static int bq2597x_enable_busovp_alarm(struct bq2597x *bq, bool enable)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_07, BQ2597X_BUS_OVP_ALM_DIS_MASK, val);
	return ret;
}
...
static int bq2597x_set_busovp_alarm_th(struct bq2597x *bq, int threshold)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_07, BQ2597X_BUS_OVP_ALM_MASK, val);
	return ret;
}
...
static int bq2597x_enable_busocp(struct bq2597x *bq, bool enable)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_08, BQ2597X_BUS_OCP_DIS_MASK, val);
	return ret;
}
...
static int bq2597x_set_busocp_th(struct bq2597x *bq, int threshold)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_08, BQ2597X_BUS_OCP_MASK, val);
	return ret;
}
...
static int bq2597x_enable_busocp_alarm(struct bq2597x *bq, bool enable)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_09, BQ2597X_BUS_OCP_ALM_DIS_MASK, val);
	return ret;
}
...
static int bq2597x_set_busocp_alarm_th(struct bq2597x *bq, int threshold)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_09, BQ2597X_BUS_OCP_ALM_MASK, val);
	return ret;
}
...
static int bq2597x_enable_batucp_alarm(struct bq2597x *bq, bool enable)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_04, BQ2597X_BAT_UCP_ALM_DIS_MASK, val);
	return ret;
}
...
static int bq2597x_set_batucp_alarm_th(struct bq2597x *bq, int threshold)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_04, BQ2597X_BAT_UCP_ALM_MASK, val);
	return ret;
}
...
static int bq2597x_set_vdrop_th(struct bq2597x *bq, int threshold)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_05, BQ2597X_VDROP_THRESHOLD_SET_MASK, val);
...
static int bq2597x_set_vdrop_deglitch(struct bq2597x *bq, int us)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_05, BQ2597X_VDROP_DEGLITCH_SET_MASK, val);
	return ret;
}
...
static int bq2597x_enable_bat_therm(struct bq2597x *bq, bool enable)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_0C, BQ2597X_TSBAT_DIS_MASK, val);
	return ret;
}
...
static int bq2597x_enable_bus_therm(struct bq2597x *bq, bool enable)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_0C, BQ2597X_TSBUS_DIS_MASK, val);
	return ret;
}
...
static int bq2597x_enable_die_therm(struct bq2597x *bq, bool enable)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_0C, BQ2597X_TDIE_DIS_MASK, val);
	return ret;
}
...
static int bq2597x_set_die_therm_th(struct bq2597x *bq, u8 threshold)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_2A, BQ2597X_TDIE_ALM_MASK, val);
	return ret;
}
...
static int bq2597x_set_adc_average(struct bq2597x *bq, bool avg)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_14, BQ2597X_ADC_AVG_MASK, val);
	return 0;
}
...
static int bq2597x_set_adc_bits(struct bq2597x *bq, int bits)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_14, BQ2597X_ADC_SAMPLE_MASK, val);
	return ret;
}
...
static int bq2597x_set_sense_resistor(struct bq2597x *bq, int r_mohm)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_2B, BQ2597X_SET_IBAT_SNS_RES_MASK, val);
	return ret;
}
...
static int bq2597x_enable_regulation(struct bq2597x *bq, bool enable)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_2B, BQ2597X_EN_REGULATION_MASK, val);
...
static int bq2597x_set_ss_timeout(struct bq2597x *bq, int timeout)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_2B, BQ2597X_SS_TIMEOUT_SET_MASK, val);
...
static int bq2597x_set_ibat_reg_th(struct bq2597x *bq, int th_ma)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_2C, BQ2597X_IBAT_REG_MASK, val);
...
static int bq2597x_set_vbat_reg_th(struct bq2597x *bq, int th_mv)
{
	...
	ret = bq2597x_update_bits(bq, BQ2597X_REG_2C, BQ2597X_VBAT_REG_MASK, val);
...
static ssize_t bq2597x_show_registers(struct device *dev, struct device_attribute *attr, char *buf)
{
...
static ssize_t bq2597x_store_register(struct device *dev, struct device_attribute *attr, const char *buf, size_t count)
{
	struct bq2597x *bq = dev_get_drvdata(dev);
	int ret;
	unsigned int reg;
...
void voov_enable_bq2597x(void)
{
	...
	bq_err("voov_enable_bq2597x----------------------------- READ 0X0C = 0x%x\n", val);
...
static struct of_device_id bq2597x_charger_match_table[] = {
	...
	{
		.compatible = "oplus,bq2597x-master",
		.data = &bq2597x_mode_data[BQ25970_MASTER],
	},

	{
		.compatible = "oplus,bq2597x-slave",
...
void oplus_cp_low_current_eint_register(struct bq2597x *chip)
{
	...
	if (node) {
		...
		ret = request_irq(chip->cp_lc_irq, (irq_handler_t)irq_rx_handler, IRQF_TRIGGER_FALLING,
				  "CP_LOW_CURRENT-eint", chip);
		if (ret < 0) {
			chg_err("Unable to request ccdetect-change irq: %d\n", ret);
		}

		if (ret < 0) {
			chg_err("ret = %d, oplus_cp_low_current_eint_register failed to request_irq \n", ret);
		} else
			chg_err("ret = %d, oplus_cp_low_current_eint_register OK to request_irq \n", ret);
	}
}
...
struct oplus_vooc_cp oplus_rkbq2597x_ops = { .hardware_init_cp = bq2597x_hardware_init,
...
static int bq2597x_charger_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	struct bq2597x *bq;
...
*/
	if (0) {
		...
		ret = devm_request_threaded_irq(&client->dev, client->irq, NULL, bq2597x_charger_interrupt,
						IRQF_TRIGGER_FALLING | IRQF_ONESHOT, "bq2597x charger irq", bq);
		if (ret < 0) {
