...
static void sgm41512_check_ibat(void)
{
	...
	pr_err("led_off,batt_temp=%d,ibat_last=%d,flag=%d\n", batt_temp, charger_ic->ibat_last,
	       charger_ic->charge_normal_temp_high_flag);
	...
	if (batt_temp >= CHARGER_NORMAL_TEMP_HIGH) {
		...
		if (!charger_ic->charge_normal_temp_high_flag && high_count >= 5) {
			...
			if (charger_ic->ibat_last > CHARGER_NORMAL_TEMP_HIGH_CURRENT) {
				sgm41512_config_interface(charger_ic, REG02_SGM41512_ADDRESS,
							  CHARGER_NORMAL_TEMP_HIGH_REG,
...
void sgm41512_switch_headset_plugin(void)
{
	...
	if (ui_soc >= HEADSET_PLUG_LIMIT_SOC) {
		...
		if (reg_val >= REG00_SGM41512_INPUT_CURRENT_LIMIT_1400MA)
			sgm41512_config_interface(charger_ic, REG00_SGM41512_ADDRESS,
						  REG00_SGM41512_INPUT_CURRENT_LIMIT_1400MA,
...
void sgm41512_switch_headset_plugout(void)
{
	...
	if (charger_ic->input_current_last != 0)
		sgm41512_config_interface(charger_ic, REG00_SGM41512_ADDRESS, charger_ic->input_current_last,
					  REG00_SGM41512_INPUT_CURRENT_LIMIT_MASK);
}
...
static int sgm41512_input_current_limit_write(int value)
{
	...
	if (value <= 0) {
		rc = sgm41512_config_interface(chip, REG00_SGM41512_ADDRESS, 0,
					       REG00_SGM41512_INPUT_CURRENT_LIMIT_MASK);
		...
		rc = sgm41512_config_interface(chip, REG00_SGM41512_ADDRESS, reg_val,
					       REG00_SGM41512_INPUT_CURRENT_LIMIT_MASK);
	}
	...
	j = 2; /* 500 */
	rc = sgm41512_config_interface(chip, REG00_SGM41512_ADDRESS, REG00_SGM41512_INPUT_CURRENT_LIMIT_500MA,
				       REG00_SGM41512_INPUT_CURRENT_LIMIT_MASK);
	msleep(90);
	...
	j = 3; /* 900 */
	rc = sgm41512_config_interface(chip, REG00_SGM41512_ADDRESS, REG00_SGM41512_INPUT_CURRENT_LIMIT_900MA,
				       REG00_SGM41512_INPUT_CURRENT_LIMIT_MASK);
	msleep(90);
	chg_vol = battery_get_vbus();
	if (chg_vol < aicl_point_temp) {
	...
	j = 4; /* 1200 */
	rc = sgm41512_config_interface(chip, REG00_SGM41512_ADDRESS, REG00_SGM41512_INPUT_CURRENT_LIMIT_1200MA,
				       REG00_SGM41512_INPUT_CURRENT_LIMIT_MASK);
	msleep(90);
	chg_vol = battery_get_vbus();
	if (chg_vol < aicl_point_temp) {
	...
	j = 5; /* 1500 */
	rc = sgm41512_config_interface(chip, REG00_SGM41512_ADDRESS, REG00_SGM41512_INPUT_CURRENT_LIMIT_1500MA,
				       REG00_SGM41512_INPUT_CURRENT_LIMIT_MASK);
	msleep(90);
	chg_vol = battery_get_vbus();
	if (chg_vol < aicl_point_temp) {
	...
	j = 6; /* 2000 */
	rc = sgm41512_config_interface(chip, REG00_SGM41512_ADDRESS, REG00_SGM41512_INPUT_CURRENT_LIMIT_2000MA,
				       REG00_SGM41512_INPUT_CURRENT_LIMIT_MASK);
	msleep(90);
	...
	j = 7; /* 3000 */
	rc = sgm41512_config_interface(chip, REG00_SGM41512_ADDRESS, REG00_SGM41512_INPUT_CURRENT_LIMIT_3000MA,
				       REG00_SGM41512_INPUT_CURRENT_LIMIT_MASK);
	msleep(90);
	chg_vol = battery_get_vbus();
	if (chg_vol < aicl_point_temp) {
...
aicl_rerun:
	...
	switch (j) {
	case 0:
		sgm41512_config_interface(chip, REG00_SGM41512_ADDRESS, REG00_SGM41512_INPUT_CURRENT_LIMIT_100MA,
					  REG00_SGM41512_INPUT_CURRENT_LIMIT_MASK);
		break;
	case 1:
		sgm41512_config_interface(chip, REG00_SGM41512_ADDRESS, REG00_SGM41512_INPUT_CURRENT_LIMIT_300MA,
					  REG00_SGM41512_INPUT_CURRENT_LIMIT_MASK);
		break;
	case 2:
		sgm41512_config_interface(chip, REG00_SGM41512_ADDRESS, REG00_SGM41512_INPUT_CURRENT_LIMIT_500MA,
					  REG00_SGM41512_INPUT_CURRENT_LIMIT_MASK);
		break;
	case 3:
		sgm41512_config_interface(chip, REG00_SGM41512_ADDRESS, REG00_SGM41512_INPUT_CURRENT_LIMIT_900MA,
					  REG00_SGM41512_INPUT_CURRENT_LIMIT_MASK);
		break;
	case 4:
		sgm41512_config_interface(chip, REG00_SGM41512_ADDRESS, REG00_SGM41512_INPUT_CURRENT_LIMIT_1200MA,
					  REG00_SGM41512_INPUT_CURRENT_LIMIT_MASK);
		break;
	case 5:
		if ((charger_ic->headset_plugin_flag == 1) && (ui_soc >= HEADSET_PLUG_LIMIT_SOC)) {
			...
			sgm41512_config_interface(chip, REG00_SGM41512_ADDRESS,
						  REG00_SGM41512_INPUT_CURRENT_LIMIT_1500MA,
						  REG00_SGM41512_INPUT_CURRENT_LIMIT_MASK);
		}
		break;
	case 6:
		if ((charger_ic->headset_plugin_flag == 1) && (ui_soc >= HEADSET_PLUG_LIMIT_SOC)) {
			...
			sgm41512_config_interface(chip, REG00_SGM41512_ADDRESS,
						  REG00_SGM41512_INPUT_CURRENT_LIMIT_2000MA,
						  REG00_SGM41512_INPUT_CURRENT_LIMIT_MASK);
		}
		break;
	case 7:
		if ((charger_ic->headset_plugin_flag == 1) && (ui_soc >= HEADSET_PLUG_LIMIT_SOC)) {
			...
			sgm41512_config_interface(chip, REG00_SGM41512_ADDRESS,
						  REG00_SGM41512_INPUT_CURRENT_LIMIT_3000MA,
						  REG00_SGM41512_INPUT_CURRENT_LIMIT_MASK);
		}
		break;
	default:
	...
	*/
	...
	if ((g_oplus_chip->stop_chg == 0 && g_oplus_chip->mmi_chg == 0) ||
	    ((g_oplus_chip->stop_chg == 0 && g_oplus_chip->mmi_chg == 1) &&
	     (charger_type_sgm == POWER_SUPPLY_TYPE_USB || charger_type_sgm == POWER_SUPPLY_TYPE_USB_CDP))) {
		pr_err("%s: stop_chg, limit the input current to 100mA \n", __func__);
		rc = sgm41512_config_interface(chip, REG00_SGM41512_ADDRESS, REG00_SGM41512_INPUT_CURRENT_LIMIT_100MA,
					       REG00_SGM41512_INPUT_CURRENT_LIMIT_MASK);
	}
...
static int sgm41512_charging_current_write_fast(int chg_cur)
{
	...
	if (chg_cur > REG02_SGM41512_MAX_FAST_CHG_CURRENT_MA || chg_cur < REG02_SGM41512_MIN_FAST_CHG_CURRENT_MA)
	...
	rc = sgm41512_config_interface(chip, REG02_SGM41512_ADDRESS, value, REG02_SGM41512_FAST_CHG_CURRENT_LIMIT_MASK);
	if (rc < 0) {
...
static int sgm41512_set_vindpm_vol(int vol)
{
	...
	rc = sgm41512_config_interface(chip, REG06_SGM41512_ADDRESS, value, REG06_SGM41512_VINDPM_MASK);
	rc = sgm41512_config_interface(chip, REG07_SGM41512_ADDRESS, REG07_SGM41512_VINDPMTRACK_VALUE,
				       REG07_SGM41512_VINDPMTRACK_MASK);
	return rc;
}
...
static int sgm41512_set_termchg_current(int term_curr)
{
	...
	rc = sgm41512_config_interface(chip, REG03_SGM41512_ADDRESS, value, REG03_SGM41512_TERM_CHG_CURRENT_LIMIT_MASK);
	if (rc < 0) {
...
static int sgm41512_set_chging_term_disable(void)
{
	...
	rc = sgm41512_config_interface(chip, REG05_SGM41512_ADDRESS, REG05_SGM41512_TERMINATION_DISABLE,
...
static int sgm41512_enable_charging(void)
{
	...
	rc = sgm41512_config_interface(chip, REG01_SGM41512_ADDRESS, REG01_SGM41512_CHARGING_ENABLE,
...
static int sgm41512_disable_charging(void)
{
	...
	rc = sgm41512_config_interface(chip, REG01_SGM41512_ADDRESS, REG01_SGM41512_CHARGING_DISABLE,
				       REG01_SGM41512_CHARGING_MASK);
	if (rc < 0)
...
int sgm41512_otg_enable(void)
{
	...
	oplus_otg_online = 1;
	sgm41512_config_interface(chip, REG00_SGM41512_ADDRESS, REG00_SGM41512_SUSPEND_MODE_DISABLE,
				  REG00_SGM41512_SUSPEND_MODE_MASK);

	rc = sgm41512_config_interface(chip, REG01_SGM41512_ADDRESS, REG01_SGM41512_OTG_ENABLE,
...
int sgm41512_otg_disable(void)
{
	...
	rc = sgm41512_config_interface(chip, REG01_SGM41512_ADDRESS, REG01_SGM41512_OTG_DISABLE,
				       REG01_SGM41512_OTG_MASK);
	if (rc)
...
static int sgm41512_set_hiz_mode()
{
	...
	rc = sgm41512_config_interface(chip, REG00_SGM41512_ADDRESS, REG00_SGM41512_SUSPEND_MODE_ENABLE,
				       REG00_SGM41512_SUSPEND_MODE_MASK);
	if (rc < 0)
...
static int sgm41512_exit_hiz_mode()
{
	...
	rc = sgm41512_config_interface(chip, REG00_SGM41512_ADDRESS, REG00_SGM41512_SUSPEND_MODE_DISABLE,
				       REG00_SGM41512_SUSPEND_MODE_MASK);
	if (rc < 0)
...
static int sgm41512_unsuspend_charger(void)
{
	...
	if (g_oplus_chip) {
		if (oplus_vooc_get_fastchg_to_normal() == false && oplus_vooc_get_fastchg_to_warm() == false) {
			if (g_oplus_chip->mmi_chg && (g_oplus_chip->charging_state != CHARGING_STATUS_FAIL)) {
	...
	if (((val_reg & REG0A_SGM41512_VBUS_GOOD_STAT_MASK) >> 7) == 0 && !fastchg_flag) {
		pr_err("unsuspend sgm41512 trigger once irq val_reg =%d vbus=%d fastchg_to_normal=%d fastchg_to_warm=%d fastchg_dummy_start=%d\n",
		       val_reg, vbus, oplus_voocphy_get_fastchg_to_normal(), oplus_voocphy_get_fastchg_to_warm(),
...
void sgm41512_set_boost_lim(unsigned int val)
{
	...
	ret = sgm41512_config_interface(chip, REG02_SGM41512_ADDRESS, val, REG02_SGM41512_OTG_CURRENT_LIMIT_MASK);
}
...
const unsigned int BOOST_CURRENT_LIMIT[] = { 500, 1200 };

static int sgm41512_set_boost_current_limit(struct charger_device *chg_dev, u32 uA)
{
	int ret = 0;
	u32 array_size = 0;
	u32 boost_ilimit = 0;
...
static int sgm41512_enable_charger_type_det(struct charger_device *dev, bool en)
{
	...
	if (en == 0 && hiz_status && !oplus_vooc_get_fastchg_started() && !oplus_chg_get_wait_for_ffc_flag() &&
	    !oplus_voocphy_get_fastchg_dummy_start()) {
		pr_err("%s fastchg_started = %d waiting_for_ffc = %d fastchg_dummy_start = %d\n", __func__,
		       oplus_vooc_get_fastchg_started(), oplus_chg_get_wait_for_ffc_flag(),
		       oplus_voocphy_get_fastchg_dummy_start());
		schedule_delayed_work(&sgm41512_threaded_irq_work, 0);
	} else if (en == 1) {
		if ((g_oplus_chip->stop_chg == 0 && g_oplus_chip->mmi_chg == 0) ||
...
enum charger_type mt_charger_type_detection_sgm41512(void)
{
	...
	if (charger_ic->chip_id == 2 || charger_ic->chip_id == 3) {
		...
		sgm41512_config_interface(charger_ic, REG07_SGM41512_ADDRESS, REG07_SGM41512_IINDET_EN_FORCE_DET,
					  REG07_SGM41512_IINDET_EN_MASE);
	...
	} else if (val_buf == REG08_SGM41512_VBUS_STAT_DCP || val_buf == REG08_SGM41512_VBUS_STAT_OCP ||
	...
	for (i = 0; i < retry_times; i++) {
		if (((MTK_CHR_Type_num == CHARGER_UNKNOWN) || (MTK_CHR_Type_num == STANDARD_HOST) ||
		     (MTK_CHR_Type_num == CHARGING_HOST)) &&
		    charger_ic->pwr_gd) {
			if (unknown_type_flag == 1 &&
			    (MTK_CHR_Type_num == STANDARD_HOST || MTK_CHR_Type_num == CHARGING_HOST)) {
				retry_times++;
				unknown_type_flag = 0;
			}
...
static int sgm41512_inform_psy_changed(bool vbus_gd)
{
	...
	ret = power_supply_set_property(psy, POWER_SUPPLY_PROP_CHARGE_TYPE, &propval);
	if (ret < 0)
...
static void do_sgm41512_irq_delay_work(struct work_struct *data)
{
	...
	pr_err("[OPPO_CHG] do_sgm41512_irq_delay_work disable vbus out flag=%d, val_reg[0x%x]\n", otg_overcurrent_flag,
	       val_reg);
...
static int sgm41512_parse_dts(void)
{
	...
	chip->enable_headset_plugin_limit =
		of_property_read_bool(chip->client->dev.of_node, "enable_headset_plugin_limit");
...
static void do_sgm41512_threaded_irq_work(struct work_struct *data)
{
	...
	if (chip->pwr_gd != power_good) {
		...
		if (chip->enable_headset_plugin_limit) {
			if (chip->pwr_gd) {
				schedule_delayed_work(&charger_ic->check_ibat_work,
...
static void sgm41512_init_status_work(struct work_struct *work)
{
	...
	struct chip_sgm41512 *chip = container_of(dwork, struct chip_sgm41512, init_status_work);
	if (chip == NULL) {
...
static int sgm41512_irq_registration(void)
{
	...
	ret = request_threaded_irq(gpio_to_irq(chip->irq_gpio), NULL, sgm41512_irq_handler_fn,
				   IRQF_TRIGGER_FALLING | IRQF_ONESHOT, "SGM41512-eint", chip);
	if (ret < 0) {
...
static int sgm41512_charger_get_property(struct power_supply *psy, enum power_supply_property psp,
...
static char *sgm41512_charger_supplied_to[] = { "battery", "mtk-master-charger" };
...
static int sgm41512_chg_init_psy(struct chip_sgm41512 *chip)
{
	...
	chip->psy = devm_power_supply_register(chip->dev, &chip->psy_desc, &cfg);
...
static int pd_tcp_notifier_call(struct notifier_block *nb, unsigned long event, void *data)
{
	...
	struct chip_sgm41512 *chip = (struct chip_sgm41512 *)container_of(nb, struct chip_sgm41512, pd_nb);
...
static int sgm41512_driver_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	chan_vbus = devm_iio_channel_get(&client->dev, "pmic_vbus_voltage");
	if (IS_ERR(chan_vbus)) {
	...
	chip->chg_dev =
		charger_device_register(chip->chg_dev_name, &client->dev, chip, &sgm41512_chg_ops, &chip->chg_props);
	...
	schedule_delayed_work(&charger_modefy_work, round_jiffies_relative(msecs_to_jiffies(10000)));
	schedule_delayed_work(&chip->init_status_work, round_jiffies_relative(msecs_to_jiffies(INIT_STATUS_TIME_5S)));
	pr_err("call OK!\n");
