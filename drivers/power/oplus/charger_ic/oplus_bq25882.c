...
int bq25882_set_vindpm_vol(int vol)
{
	...
	rc = bq25882_config_interface(REG02_BQ25882_ADDRESS, tmp << REG02_BQ25882_INPUT_VOLTAGE_LIMIT_SHIFT,
				      REG02_BQ25882_INPUT_VOLTAGE_LIMIT_MASK);
...
int bq25882_input_current_limit_write(int current_ma)
{
	...
	if (pre_icl_index < 2) {
		...
		for (i = pre_icl_index - 1; i > 0; i--) {
			switch (i) {
			case 1:
				bq25882_config_interface(REG03_BQ25882_ADDRESS, REG03_BQ25882_INPUT_CURRENT_LIMIT_900MA,
							 REG03_BQ25882_INPUT_CURRENT_LIMIT_MASK);
				break;
			case 2:
				bq25882_config_interface(REG03_BQ25882_ADDRESS,
							 REG03_BQ25882_INPUT_CURRENT_LIMIT_1200MA,
							 REG03_BQ25882_INPUT_CURRENT_LIMIT_MASK);
				break;
			case 3:
				bq25882_config_interface(REG03_BQ25882_ADDRESS,
							 REG03_BQ25882_INPUT_CURRENT_LIMIT_1500MA,
							 REG03_BQ25882_INPUT_CURRENT_LIMIT_MASK);
				break;
			case 4:
				bq25882_config_interface(REG03_BQ25882_ADDRESS,
							 REG03_BQ25882_INPUT_CURRENT_LIMIT_1700MA,
							 REG03_BQ25882_INPUT_CURRENT_LIMIT_MASK);
				break;
			case 5:
				bq25882_config_interface(REG03_BQ25882_ADDRESS,
							 REG03_BQ25882_INPUT_CURRENT_LIMIT_2000MA,
							 REG03_BQ25882_INPUT_CURRENT_LIMIT_MASK);
				break;
			default:
				break;
	...
	i = 0; /* 500 */
	bq25882_config_interface(REG03_BQ25882_ADDRESS, REG03_BQ25882_INPUT_CURRENT_LIMIT_500MA,
				 REG03_BQ25882_INPUT_CURRENT_LIMIT_MASK);
	msleep(90);
	...
	i = 2; /* 1200 */
	bq25882_config_interface(REG03_BQ25882_ADDRESS, REG03_BQ25882_INPUT_CURRENT_LIMIT_1200MA,
				 REG03_BQ25882_INPUT_CURRENT_LIMIT_MASK);
	msleep(90);
	chg_vol = bq25882_get_charger_vol();
	if (chg_vol < chip->sw_aicl_point) {
	...
	i = 3; /* 1500 */
	bq25882_config_interface(REG03_BQ25882_ADDRESS, REG03_BQ25882_INPUT_CURRENT_LIMIT_1500MA,
				 REG03_BQ25882_INPUT_CURRENT_LIMIT_MASK);
	msleep(50);
	chg_vol = bq25882_get_charger_vol();
	if (chg_vol < chip->sw_aicl_point) {
	...
	i = 4; /* 1700 */
	bq25882_config_interface(REG03_BQ25882_ADDRESS, REG03_BQ25882_INPUT_CURRENT_LIMIT_1700MA,
				 REG03_BQ25882_INPUT_CURRENT_LIMIT_MASK);
	msleep(90);
	chg_vol = bq25882_get_charger_vol();
	if (chg_vol < chip->sw_aicl_point) {
	...
	i = 5; /* 2000 */
	bq25882_config_interface(REG03_BQ25882_ADDRESS, REG03_BQ25882_INPUT_CURRENT_LIMIT_2000MA,
				 REG03_BQ25882_INPUT_CURRENT_LIMIT_MASK);
	msleep(90);
	chg_vol = bq25882_get_charger_vol();
	if (chg_vol < chip->sw_aicl_point) {
...
aicl_pre_step:
	chg_debug("usb input max current limit aicl chg_vol=%d j[%d]=%d sw_aicl_point:%d aicl_pre_step\n", chg_vol, i,
		  bq25882_usbin_input_current_limit[i], chip->sw_aicl_point);
	goto aicl_rerun;
aicl_end:
...
int bq25882_charging_current_write_fast(int chg_cur)
{
	...
	rc = bq25882_config_interface(REG01_BQ25882_ADDRESS, tmp << REG01_BQ25882_FAST_CURRENT_LIMIT_SHIFT,
...
int bq25882_set_complete_charge_timeout(int val)
{
	...
	rc = bq25882_config_interface(REG05_BQ25882_ADDRESS, val,
				      REG05_BQ25882_EN_TIMER_MASK | REG05_BQ25882_CHG_TIMER_MASK);
	if (rc < 0) {
...
int bq25882_float_voltage_write(int vfloat_mv)
{
	...
	rc = bq25882_config_interface(REG00_BQ25882_ADDRESS, tmp << REG00_BQ25882_BAT_THRESHOLD_SHIFT,
...
int bq25882_set_prechg_current(int ipre_mA)
{
	...
	rc = bq25882_config_interface(REG04_BQ25882_ADDRESS, tmp << REG04_BQ25882_IPRECHG_LIMIT_SHIFT,
				      REG04_BQ25882_IPRECHG_LIMIT_MASK);
...
int bq25882_set_termchg_current(int term_curr)
{
	...
	rc = bq25882_config_interface(REG04_BQ25882_ADDRESS, tmp << REG04_BQ25882_ITERM_LIMIT_SHIFT,
				      REG04_BQ25882_ITERM_LIMIT_MASK);
	return rc;
}
...
int bq25882_set_rechg_voltage(int recharge_mv)
{
	...
	rc = bq25882_config_interface(REG06_BQ25882_ADDRESS, tmp << REG06_BQ25882_VRECHG_SHIFT,
				      REG06_BQ25882_VRECHG_MASK);
	if (rc) {
...
int bq25882_set_chging_term_disable(void)
{
	...
	rc = bq25882_config_interface(REG05_BQ25882_ADDRESS, REG05_BQ25882_EN_TERM_DISABLE, REG05_BQ25882_EN_TERM_MASK);
	if (rc) {
...
int bq25882_enable_charging(void)
{
	...
	rc = bq25882_config_interface(REG06_BQ25882_ADDRESS, REG06_BQ25882_EN_CHG_ENABLE, REG06_BQ25882_EN_CHG_MASK);
	if (rc < 0) {
...
int bq25882_disable_charging(void)
{
	...
	rc = bq25882_config_interface(REG06_BQ25882_ADDRESS, REG06_BQ25882_EN_CHG_DISABLE, REG06_BQ25882_EN_CHG_MASK);
	if (rc < 0) {
...
int bq25882_reset_charger(void)
{
	...
	rc = bq25882_config_interface(REG25_BQ25882_ADDRESS, REG25_BQ25882_RESET_DEFAULT, REG25_BQ25882_RESET_MASK);
	if (rc < 0) {
...
int bq25882_otg_vlim_set(int vlim)
{
	...
	rc = bq25882_config_interface(REG09_BQ25882_ADDRESS, vlim, REG09_BQ25882_OTG_VLIM_MASK);
	if (rc < 0) {
...
int bq25882_otg_ilim_set(int ilim)
{
	...
	rc = bq25882_config_interface(REG09_BQ25882_ADDRESS, ilim, REG09_BQ25882_OTG_ILIM_MASK);
	if (rc < 0) {
...
int bq25882_otg_enable(void)
{
	...
	rc = bq25882_config_interface(REG06_BQ25882_ADDRESS, REG06_BQ25882_EN_OTG_ENABLE, REG06_BQ25882_EN_OTG_MASK);
	if (rc < 0) {
...
int bq25882_otg_disable(void)
{
	...
	rc = bq25882_config_interface(REG06_BQ25882_ADDRESS, REG06_BQ25882_EN_OTG_DISABLE, REG06_BQ25882_EN_OTG_MASK);
	if (rc < 0) {
...
int bq25882_ico_disable(void)
{
	...
	rc = bq25882_config_interface(REG03_BQ25882_ADDRESS, REG03_BQ25882_EN_ICO_DISABLE, REG03_BQ25882_EN_ICO_MASK);
	if (rc < 0) {
...
int bq25882_adc_en_enable(bool enable)
{
	...
	if (enable == false) {
		rc = bq25882_config_interface(REG15_BQ25882_ADDRESS, 0x0,
					      0xFF); //REG15_BQ25882_ADC_EN_DISABLE, REG15_BQ25882_ADC_EN_MASK);
		if (rc < 0) {
			chg_err("Couldn't bq25882_adc_en_disable  rc = %d\n", rc);
		}
	} else {
		rc = bq25882_config_interface(REG15_BQ25882_ADDRESS, 0x80,
					      0xFF); //REG15_BQ25882_ADC_EN_ENABLE, REG15_BQ25882_ADC_EN_MASK);
		if (rc < 0) {
...
int bq25882_ibus_adc_dis_enable(void)
{
	...
	rc = bq25882_config_interface(REG16_BQ25882_ADDRESS, 0x00,
				      0xFF); //REG16_BQ25882_IBUS_ADC_DIS_ENABLE, REG16_BQ25882_IBUS_ADC_DIS_MASK);
	if (rc < 0) {
...
int bq25882_ichg_adc_dis_enable(void)
{
	...
	rc = bq25882_config_interface(REG16_BQ25882_ADDRESS, 0x00,
				      0xFF); //REG16_BQ25882_ICHG_ADC_DIS_ENABLE, REG16_BQ25882_ICHG_ADC_DIS_MASK);
	if (rc < 0) {
...
void bq25882_dump_registers(void)
{
	...
	if (dump_count == DUMP_REG_LOG_CNT_30S) {
		...
		printk(KERN_ERR
		       "bq25882[0-0C]: 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x,",
		       val_buf[0], val_buf[1], val_buf[2], val_buf[3], val_buf[4], val_buf[5], val_buf[6], val_buf[7],
		       val_buf[8], val_buf[9], val_buf[10], val_buf[11], val_buf[12]);
		printk(KERN_ERR
		       "bq25882[0D-19]: 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x,",
		       val_buf[13], val_buf[14], val_buf[15], val_buf[16], val_buf[17], val_buf[18], val_buf[19],
		       val_buf[20], val_buf[21], val_buf[22], val_buf[23], val_buf[24], val_buf[25]);
		printk(KERN_ERR
		       "bq25882[1A-25]: 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x, 0x%x \n",
		       val_buf[26], val_buf[27], val_buf[28], val_buf[29], val_buf[30], val_buf[31], val_buf[32],
		       val_buf[33], val_buf[34], val_buf[35], val_buf[36], val_buf[37]);
	}
	dump_count++;
}
...
static int bq25882_input_current_limit_init(void)
{
	...
	rc = bq25882_config_interface(REG03_BQ25882_ADDRESS, REG03_BQ25882_INPUT_CURRENT_LIMIT_500MA,
				      REG03_BQ25882_INPUT_CURRENT_LIMIT_MASK);
	if (rc < 0) {
...
static int bq25882_driver_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	chg_ic = devm_kzalloc(&client->dev, sizeof(struct chip_bq25882), GFP_KERNEL);
	if (!chg_ic) {
