...
int sgm41511_set_vindpm_vol(int vol)
{
	...
	rc = sgm41511_config_interface(chip, REG06_SGM41511_ADDRESS, tmp << REG06_SGM41511_VINDPM_SHIFT,
...
int sgm41511_input_current_limit_without_aicl(int current_ma)
{
	...
	rc = sgm41511_config_interface(chip, REG00_SGM41511_ADDRESS, tmp << REG00_SGM41511_INPUT_CURRENT_LIMIT_SHIFT,
...
aicl_pre_step:
	chg_debug("usb input max current limit aicl chg_vol=%d j[%d]=%d sw_aicl_point:%d aicl_pre_step\n", chg_vol, i,
		  sgm41511_usb_icl[i], sw_aicl_point);
	goto aicl_rerun;
aicl_end:
...
static ssize_t sgm41511_access_show(struct device *dev, struct device_attribute *attr, char *buf)
{
...
static ssize_t sgm41511_access_store(struct device *dev, struct device_attribute *attr, const char *buf, size_t size)
{
	struct chip_sgm41511 *chip = dev_get_drvdata(dev);
	int ret = 0;
...
int sgm41511_kick_wdt(void)
{
	...
	rc = sgm41511_config_interface(chip, REG01_SGM41511_ADDRESS, REG01_SGM41511_WDT_TIMER_RESET,
...
int sgm41511_set_wdt_timer(int reg)
{
	...
	rc = sgm41511_config_interface(chip, REG05_SGM41511_ADDRESS, reg, REG05_SGM41511_WATCHDOG_TIMER_MASK);
	if (rc) {
...
int sgm41511_set_int_mask(int val)
{
	...
	rc = sgm41511_config_interface(chip, REG0A_SGM41511_ADDRESS, val,
...
int sgm41511_set_chg_timer(bool enable)
{
	...
	rc = sgm41511_config_interface(chip, REG05_SGM41511_ADDRESS,
				       enable ? REG05_SGM41511_CHG_SAFETY_TIMER_ENABLE :
						REG05_SGM41511_CHG_SAFETY_TIMER_DISABLE,
...
int sgm41511_charging_current_write_fast(int chg_cur)
{
	...
	rc = sgm41511_config_interface(chip, REG02_SGM41511_ADDRESS, tmp << REG02_SGM41511_FAST_CHG_CURRENT_LIMIT_SHIFT,
...
int sgm41511_float_voltage_write(int vfloat_mv)
{
	...
	rc = sgm41511_config_interface(chip, REG04_SGM41511_ADDRESS, tmp << REG04_SGM41511_CHG_VOL_LIMIT_SHIFT,
...
int sgm41511_set_termchg_current(int term_curr)
{
	...
	rc = sgm41511_config_interface(chip, REG03_SGM41511_ADDRESS, tmp << REG03_SGM41511_PRE_CHG_CURRENT_LIMIT_SHIFT,
...
int sgm41511_otg_ilim_set(int ilim)
{
	...
	rc = sgm41511_config_interface(chip, REG02_SGM41511_ADDRESS, ilim, REG02_SGM41511_OTG_CURRENT_LIMIT_MASK);
	if (rc < 0) {
...
int sgm41511_otg_enable(void)
{
	...
	rc = sgm41511_config_interface(chip, REG01_SGM41511_ADDRESS, REG01_SGM41511_OTG_ENABLE,
...
int sgm41511_otg_disable(void)
{
	...
	rc = sgm41511_config_interface(chip, REG01_SGM41511_ADDRESS, REG01_SGM41511_OTG_DISABLE,
				       REG01_SGM41511_OTG_MASK);
	if (rc < 0) {
...
int sgm41511_enable_charging(void)
{
	...
	rc = sgm41511_config_interface(chip, REG01_SGM41511_ADDRESS, REG01_SGM41511_CHARGING_ENABLE,
...
int sgm41511_disable_charging(void)
{
	...
	sgm41511_otg_disable();
	rc = sgm41511_config_interface(chip, REG01_SGM41511_ADDRESS, REG01_SGM41511_CHARGING_DISABLE,
				       REG01_SGM41511_CHARGING_MASK);
	if (rc < 0) {
...
int sgm41511_set_rechg_voltage(int recharge_mv)
{
	...
	rc = sgm41511_config_interface(chip, REG04_SGM41511_ADDRESS, recharge_mv,
...
int sgm41511_reset_charger(void)
{
	...
	rc = sgm41511_config_interface(chip, REG0B_SGM41511_ADDRESS, REG0B_SGM41511_REG_RST_RESET,
...
int sgm41511_set_chging_term_disable(void)
{
	...
	rc = sgm41511_config_interface(chip, REG05_SGM41511_ADDRESS, REG05_SGM41511_TERMINATION_DISABLE,
...
int sgm41511_set_prechg_voltage_threshold(void)
{
	...
	rc = sgm41511_config_interface(chip, REG01_SGM41511_ADDRESS, REG01_SGM41511_SYS_VOL_LIMIT_3400MV,
...
int sgm41511_set_otg_voltage(void)
{
	...
	rc = sgm41511_config_interface(chip, REG06_SGM41511_ADDRESS, REG06_SGM41511_OTG_VLIM_5000MV,
...
int sgm41511_set_ovp(int val)
{
	...
	rc = sgm41511_config_interface(chip, REG06_SGM41511_ADDRESS, val, REG06_SGM41511_OVP_MASK);
...
int sgm41511_set_iindet(void)
{
	...
	rc = sgm41511_config_interface(chip, REG07_SGM41511_ADDRESS, REG07_SGM41511_IINDET_EN_MASK,
...
static int sgm41511_irq_register(struct chip_sgm41511 *chip)
{
	...
	ret = devm_request_threaded_irq(chip->dev, gpio_to_irq(chip->irq_gpio), NULL, sgm41511_irq_handler,
					IRQF_TRIGGER_FALLING | IRQF_ONESHOT, "sgm41511-eint", chip);
	if (ret < 0) {
