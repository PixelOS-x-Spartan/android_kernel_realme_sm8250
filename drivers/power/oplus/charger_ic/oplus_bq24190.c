...
static int __bq24190_read_reg(struct chip_bq24190 *chip, int reg, int *returnData)
{
	...
	charger_ic->client->ext_flag =
		((charger_ic->client->ext_flag) & I2C_MASK_FLAG) | I2C_WR_FLAG | I2C_DIRECTION_FLAG;
...
*/
	...
	j = 2; /* 500 */
	rc = bq24190_config_interface(charger_ic, REG00_BQ24190_ADDRESS, j << REG00_BQ24190_INPUT_CURRENT_LIMIT_SHIFT,
				      REG00_BQ24190_INPUT_CURRENT_LIMIT_MASK);
	msleep(90);
	chg_vol = battery_meter_get_charger_voltage();
	if (chg_vol < aicl_point_temp) {
		j = 2;
...
aicl_pre_step:
	...
	chg_debug("usb input max current limit aicl chg_vol=%d j[%d]=%d sw_aicl_point:%d aicl_pre_step\n", chg_vol, j,
		  bq24190_usbin_input_current_limit[j], aicl_point_temp);
	rc = bq24190_config_interface(charger_ic, REG00_BQ24190_ADDRESS, j << REG00_BQ24190_INPUT_CURRENT_LIMIT_SHIFT,
				      REG00_BQ24190_INPUT_CURRENT_LIMIT_MASK);
	return rc;
aicl_end:
...
static int bq24190_input_current_limit_write(int value)
{
	...
	for (j = 2; j <= i; j++) {
		bq24190_config_interface(charger_ic, REG00_BQ24190_ADDRESS,
					 j << REG00_BQ24190_INPUT_CURRENT_LIMIT_SHIFT,
					 REG00_BQ24190_INPUT_CURRENT_LIMIT_MASK);
#ifdef CONFIG_OPLUS_CHARGER_MTK
		msleep(90);
		chg_vol = battery_meter_get_charger_voltage();
		...
		if (chg_vol < charger_ic->sw_aicl_point) {
			...
			chg_debug("usb input max current limit aicl chg_vol=%d j[%d]=%d sw_aicl_point:%d\n", chg_vol, j,
				  bq24190_usbin_input_current_limit[j], charger_ic->sw_aicl_point);
			bq24190_config_interface(charger_ic, REG00_BQ24190_ADDRESS,
						 j << REG00_BQ24190_INPUT_CURRENT_LIMIT_SHIFT,
						 REG00_BQ24190_INPUT_CURRENT_LIMIT_MASK);
			return 0;
	...
	chg_debug("usb input max current limit aicl chg_vol=%d j[%d]=%d\n", chg_vol, j,
		  bq24190_usbin_input_current_limit[j]);
	rc = bq24190_config_interface(charger_ic, REG00_BQ24190_ADDRESS, j << REG00_BQ24190_INPUT_CURRENT_LIMIT_SHIFT,
				      REG00_BQ24190_INPUT_CURRENT_LIMIT_MASK);
	return rc;
}
...
static int bq24190_charging_current_write_fast(int chg_cur)
{
	...
	ret = bq24190_config_interface(charger_ic, REG02_BQ24190_ADDRESS, value,
				       REG02_BQ24190_FAST_CHARGING_CURRENT_LIMIT_MASK |
					       REG02_BQ24190_FAST_CHARGING_CURRENT_FORCE20PCT_MASK);
	return ret;
}
...
static int bq24190_set_vindpm_vol(struct chip_bq24190 *chip, int vol)
{
	...
	rc = bq24190_config_interface(charger_ic, REG00_BQ24190_ADDRESS, value, REG00_BQ24190_VINDPM_MASK);
	return rc;
}
...
static int bq24190_set_complete_charge_timeout(struct chip_bq24190 *chip, int val)
{
	...
	rc = bq24190_config_interface(charger_ic, REG05_BQ24190_ADDRESS, val,
				      REG05_BQ24190_CHARGING_SAFETY_TIME_MASK |
					      REG05_BQ24190_FAST_CHARGING_TIMEOUT_MASK);
	if (rc < 0) {
...
int bq24190_set_prechg_current(struct chip_bq24190 *chip, int ipre_mA)
{
	...
	return bq24190_config_interface(charger_ic, REG03_BQ24190_ADDRESS, value,
					REG03_BQ24190_PRE_CHARGING_CURRENT_LIMIT_MASK);
}
...
static int bq24190_set_termchg_current(int term_curr)
{
	...
	bq24190_config_interface(charger_ic, REG03_BQ24190_ADDRESS, value,
				 REG03_BQ24190_TERM_CHARGING_CURRENT_LIMIT_MASK);
	return rc;
}
...
int bq24190_set_rechg_voltage(int recharge_mv)
{
	...
	rc = bq24190_config_interface(charger_ic, REG04_BQ24190_ADDRESS, reg,
				      REG04_BQ24190_RECHARGING_THRESHOLD_VOL_MASK);
	if (rc) {
...
int bq24190_set_wdt_timer(struct chip_bq24190 *chip, int reg)
{
	...
	rc = bq24190_config_interface(charger_ic, REG05_BQ24190_ADDRESS, reg, REG05_BQ24190_I2C_WATCHDOG_TIME_MASK);
...
static int bq24190_set_chging_term_disable(void)
{
	...
	rc = bq24190_config_interface(charger_ic, REG05_BQ24190_ADDRESS, REG05_BQ24190_TERMINATION_DISABLE,
				      REG05_BQ24190_TERMINATION_MASK);
...
int bq24190_kick_wdt(void)
{
	...
	rc = bq24190_config_interface(charger_ic, REG01_BQ24190_ADDRESS, REG01_BQ24190_WDT_TIMER_RESET,
				      REG01_BQ24190_WDT_TIMER_RESET_MASK);
...
int bq24190_enable_charging(void)
{
	...
	rc = bq24190_config_interface(charger_ic, REG01_BQ24190_ADDRESS, REG01_BQ24190_CHARGING_ENABLE,
				      REG01_BQ24190_CHARGING_MASK);
	if (rc < 0) {
...
int bq24190_disable_charging(void)
{
	...
	rc = bq24190_config_interface(charger_ic, REG01_BQ24190_ADDRESS, REG01_BQ24190_CHARGING_DISABLE,
				      REG01_BQ24190_CHARGING_MASK);
	if (rc < 0) {
...
static bool bq24190_check_charger_suspend_enable(void)
{
	...
	charger_suspend_enable =
		((reg_val & REG00_BQ24190_SUSPEND_MODE_MASK) == REG00_BQ24190_SUSPEND_MODE_ENABLE) ? true : false;
...
int bq24190_registers_read_full(void)
{
	...
	reg_full = ((reg_full & REG08_BQ24190_CHARGING_STATUS_CHARGING_MASK) ==
		    REG08_BQ24190_CHARGING_STATUS_TERM_CHARGING) ?
			   1 :
			   0;
...
#endif /* CONFIG_OPLUS_CHARGER_MTK */
	bq24190_config_interface(charger_ic, REG00_BQ24190_ADDRESS, REG00_BQ24190_SUSPEND_MODE_DISABLE,
				 REG00_BQ24190_SUSPEND_MODE_MASK);

	rc = bq24190_config_interface(charger_ic, REG01_BQ24190_ADDRESS, REG01_BQ24190_OTG_ENABLE,
				      REG01_BQ24190_OTG_MASK);
	if (rc) {
...
#endif /* CONFIG_OPLUS_CHARGER_MTK */
	rc = bq24190_config_interface(charger_ic, REG01_BQ24190_ADDRESS, REG01_BQ24190_OTG_DISABLE,
				      REG01_BQ24190_OTG_MASK);
	if (rc)
...
int bq24190_suspend_charger(void)
{
	...
	rc = bq24190_config_interface(charger_ic, REG00_BQ24190_ADDRESS, REG00_BQ24190_SUSPEND_MODE_ENABLE,
				      REG00_BQ24190_SUSPEND_MODE_MASK);
	chg_debug(" rc = %d\n", rc);
	if (rc < 0) {
...
int bq24190_unsuspend_charger(void)
{
	...
	rc = bq24190_config_interface(charger_ic, REG00_BQ24190_ADDRESS, REG00_BQ24190_SUSPEND_MODE_DISABLE,
				      REG00_BQ24190_SUSPEND_MODE_MASK);
	chg_debug(" rc = %d\n", rc);
	if (rc < 0) {
...
int bq24190_reset_charger(void)
{
	...
	rc = bq24190_config_interface(charger_ic, REG01_BQ24190_ADDRESS, REG01_BQ24190_REGISTER_RESET,
				      REG01_BQ24190_REGISTER_RESET_MASK);
	chg_debug(" rc = %d\n", rc);
	if (rc < 0) {
...
void bq24190_dump_registers(void)
{
	...
	if (dump_count == DUMP_REG_LOG_CNT_30S) {
		...
		dump_count = 0;
		chg_debug(
			"bq24190_reg[0-a]:0x%02x(0),0x%02x(1),0x%02x(2),0x%02x(3),0x%02x(4),0x%02x(5),0x%02x(6),0x%02x(7),0x%02x(8),0x%02x(9),0x%02x(a)\n",
...
{
	int ret = 0;
	ret = request_threaded_irq(chip->client->irq, NULL, bq24190_irq_handler_fn, IRQF_TRIGGER_FALLING | IRQF_ONESHOT,
				   "BQ24190-eint", chip);
	if (ret < 0) {
...
static int bq24190_driver_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	chip = devm_kzalloc(&client->dev, sizeof(struct chip_bq24190), GFP_KERNEL);
	if (!chip) {
