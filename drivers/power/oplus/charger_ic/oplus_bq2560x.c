...
extern unsigned int pmic_get_register_value(struct regmap *map, unsigned int addr, unsigned int mask,
					    unsigned int shift);
...
static enum power_supply_usb_type bq2560x_charger_usb_types[] = {
	...
	POWER_SUPPLY_USB_TYPE_PD_DRP,  POWER_SUPPLY_USB_TYPE_APPLE_BRICK_ID
};
#endif
...
static void hw_bc11_init(void)
{
	...
	/* RG_bc11_BIAS_EN=1 */
	pmic_set_register_value(mt6357_regmap, PMIC_RG_BC11_BIAS_EN_ADDR, PMIC_RG_BC11_BIAS_EN_MASK,
				PMIC_RG_BC11_BIAS_EN_SHIFT, 0x1);
	/* RG_bc11_VSRC_EN[1:0]=00 */
	pmic_set_register_value(mt6357_regmap, PMIC_RG_BC11_VSRC_EN_ADDR, PMIC_RG_BC11_VSRC_EN_MASK,
				PMIC_RG_BC11_VSRC_EN_SHIFT, 0x0);
	/* RG_bc11_VREF_VTH = [1:0]=00 */
	pmic_set_register_value(mt6357_regmap, PMIC_RG_BC11_VREF_VTH_ADDR, PMIC_RG_BC11_VREF_VTH_MASK,
				PMIC_RG_BC11_VREF_VTH_SHIFT, 0x0);
	/* RG_bc11_CMP_EN[1.0] = 00 */
	pmic_set_register_value(mt6357_regmap, PMIC_RG_BC11_CMP_EN_ADDR, PMIC_RG_BC11_CMP_EN_MASK,
				PMIC_RG_BC11_CMP_EN_SHIFT, 0x0);
	/* RG_bc11_IPU_EN[1.0] = 00 */
	pmic_set_register_value(mt6357_regmap, PMIC_RG_BC11_IPU_EN_ADDR, PMIC_RG_BC11_IPU_EN_MASK,
				PMIC_RG_BC11_IPU_EN_SHIFT, 0x0);
	/* RG_bc11_IPD_EN[1.0] = 00 */
	pmic_set_register_value(mt6357_regmap, PMIC_RG_BC11_IPD_EN_ADDR, PMIC_RG_BC11_IPD_EN_MASK,
				PMIC_RG_BC11_IPD_EN_SHIFT, 0x0);
	/* bc11_RST=1 */
	pmic_set_register_value(mt6357_regmap, PMIC_RG_BC11_RST_ADDR, PMIC_RG_BC11_RST_MASK, PMIC_RG_BC11_RST_SHIFT,
				0x1);
	/* bc11_BB_CTRL=1 */
	pmic_set_register_value(mt6357_regmap, PMIC_RG_BC11_BB_CTRL_ADDR, PMIC_RG_BC11_BB_CTRL_MASK,
				PMIC_RG_BC11_BB_CTRL_SHIFT, 0x1);
	/* add pull down to prevent PMIC leakage */
	pmic_set_register_value(mt6357_regmap, PMIC_RG_BC11_IPD_EN_ADDR, PMIC_RG_BC11_IPD_EN_MASK,
				PMIC_RG_BC11_IPD_EN_SHIFT, 0x1);
	msleep(50);
...
static unsigned int hw_bc11_DCD(void)
{
	...
	pmic_set_register_value(mt6357_regmap, PMIC_RG_BC11_IPU_EN_ADDR, PMIC_RG_BC11_IPU_EN_MASK,
				PMIC_RG_BC11_IPU_EN_SHIFT, 0x2);
	/* RG_bc11_IPD_EN[1.0] = 01 */
	pmic_set_register_value(mt6357_regmap, PMIC_RG_BC11_IPD_EN_ADDR, PMIC_RG_BC11_IPD_EN_MASK,
				PMIC_RG_BC11_IPD_EN_SHIFT, 0x1);
	/* RG_bc11_VREF_VTH = [1:0]=01 */
	pmic_set_register_value(mt6357_regmap, PMIC_RG_BC11_VREF_VTH_ADDR, PMIC_RG_BC11_VREF_VTH_MASK,
				PMIC_RG_BC11_VREF_VTH_SHIFT, 0x1);
	/* RG_bc11_CMP_EN[1.0] = 10 */
	pmic_set_register_value(mt6357_regmap, PMIC_RG_BC11_CMP_EN_ADDR, PMIC_RG_BC11_CMP_EN_MASK,
				PMIC_RG_BC11_CMP_EN_SHIFT, 0x2);
	msleep(80);
	/* mdelay(80); */
	wChargerAvail = pmic_get_register_value(mt6357_regmap, PMIC_RGS_BC11_CMP_OUT_ADDR, PMIC_RGS_BC11_CMP_OUT_MASK,
...
static unsigned int hw_bc11_stepA2(void)
{
	unsigned int wChargerAvail = 0;
	pmic_set_register_value(mt6357_regmap, PMIC_RG_BC11_VSRC_EN_ADDR, PMIC_RG_BC11_VSRC_EN_MASK,
				PMIC_RG_BC11_VSRC_EN_SHIFT, 0x2);
	pmic_set_register_value(mt6357_regmap, PMIC_RG_BC11_IPD_EN_ADDR, PMIC_RG_BC11_IPD_EN_MASK,
				PMIC_RG_BC11_IPD_EN_SHIFT, 0x1);
	pmic_set_register_value(mt6357_regmap, PMIC_RG_BC11_VREF_VTH_ADDR, PMIC_RG_BC11_VREF_VTH_MASK,
				PMIC_RG_BC11_VREF_VTH_SHIFT, 0x0);
	pmic_set_register_value(mt6357_regmap, PMIC_RG_BC11_CMP_EN_ADDR, PMIC_RG_BC11_CMP_EN_MASK,
				PMIC_RG_BC11_CMP_EN_SHIFT, 0x1);
...
static unsigned int hw_bc11_stepB2(void)
{
	...
	pmic_set_register_value(mt6357_regmap, PMIC_RG_BC11_VSRC_EN_ADDR, PMIC_RG_BC11_VSRC_EN_MASK,
				PMIC_RG_BC11_VSRC_EN_SHIFT, 0x1);
	//RG_bc11_IPD_EN[1:0]=10
	pmic_set_register_value(mt6357_regmap, PMIC_RG_BC11_IPD_EN_ADDR, PMIC_RG_BC11_IPD_EN_MASK,
				PMIC_RG_BC11_IPD_EN_SHIFT, 0x2);
	//RG_bc11_VREF_VTH = [1:0]=01
	pmic_set_register_value(mt6357_regmap, PMIC_RG_BC11_VREF_VTH_ADDR, PMIC_RG_BC11_VREF_VTH_MASK,
				PMIC_RG_BC11_VREF_VTH_SHIFT, 0x0);
...
static void hw_bc11_done(void)
{
	...
	//RG_bc11_BIAS_EN=0
	pmic_set_register_value(mt6357_regmap, PMIC_RG_BC11_BIAS_EN_ADDR, PMIC_RG_BC11_BIAS_EN_MASK,
				PMIC_RG_BC11_BIAS_EN_SHIFT, 0x0);
...
static int bq2560x_get_charger_type(struct bq2560x *bq, const enum charger_type type)
{
	...
	if (chg_type == STANDARD_CHARGER || chg_type == APPLE_2_1A_CHARGER)
...
static int bq2560x_enable_otg(struct bq2560x *bq)
{
	...
	return bq2560x_update_bits(bq, BQ2560X_REG_01, REG01_OTG_CONFIG_MASK, val);
}
...
int oplus_bq2560x_set_current(int curr)
{
	...
	return bq2560x_update_bits(g_bq, BQ2560X_REG_02, REG02_ICHG_MASK, ichg << REG02_ICHG_SHIFT);
}
...
int bq2560x_set_chargecurrent(struct bq2560x *bq, int curr)
{
	...
	ichg = (curr - REG02_ICHG_BASE) / REG02_ICHG_LSB;
	return bq2560x_update_bits(bq, BQ2560X_REG_02, REG02_ICHG_MASK, ichg << REG02_ICHG_SHIFT);
}
...
int bq2560x_set_term_current(struct bq2560x *bq, int curr)
{
	...
	return bq2560x_update_bits(bq, BQ2560X_REG_03, REG03_ITERM_MASK, iterm << REG03_ITERM_SHIFT);
}
...
int bq2560x_set_prechg_current(struct bq2560x *bq, int curr)
{
	...
	return bq2560x_update_bits(bq, BQ2560X_REG_03, REG03_IPRECHG_MASK, iprechg << REG03_IPRECHG_SHIFT);
}
...
int bq2560x_set_chargevolt(struct bq2560x *bq, int volt)
{
	...
	return bq2560x_update_bits(bq, BQ2560X_REG_04, REG04_VREG_MASK, val << REG04_VREG_SHIFT);
}
...
int bq2560x_set_input_volt_limit(struct bq2560x *bq, int volt)
{
	...
	return bq2560x_update_bits(bq, BQ2560X_REG_06, REG06_VINDPM_MASK, val << REG06_VINDPM_SHIFT);
}
...
int bq2560x_set_input_current_limit(struct bq2560x *bq, int curr)
{
	...
	return bq2560x_update_bits(bq, BQ2560X_REG_00, REG00_IINLIM_MASK, val << REG00_IINLIM_SHIFT);
}
...
int bq2560x_set_boost_current(struct bq2560x *bq, int curr)
{
	...
	return bq2560x_update_bits(bq, BQ2560X_REG_02, REG02_BOOST_LIM_MASK, val << REG02_BOOST_LIM_SHIFT);
}
...
int bq2560x_set_boost_voltage(struct bq2560x *bq, int volt)
{
	...
	return bq2560x_update_bits(bq, BQ2560X_REG_06, REG06_BOOSTV_MASK, val << REG06_BOOSTV_SHIFT);
}
...
static int bq2560x_set_acovp_threshold(struct bq2560x *bq, int volt)
{
	...
	return bq2560x_update_bits(bq, BQ2560X_REG_06, REG06_OVP_MASK, val << REG06_OVP_SHIFT);
}
...
static int bq2560x_set_stat_ctrl(struct bq2560x *bq, int ctrl)
{
	...
	return bq2560x_update_bits(bq, BQ2560X_REG_00, REG00_STAT_CTRL_MASK, val << REG00_STAT_CTRL_SHIFT);
}
...
static int bq2560x_set_int_mask(struct bq2560x *bq, int mask)
{
	...
	return bq2560x_update_bits(bq, BQ2560X_REG_0A, REG0A_INT_MASK_MASK, val << REG0A_INT_MASK_SHIFT);
}
...
static int bq2560x_enable_batfet(struct bq2560x *bq)
{
	...
	return bq2560x_update_bits(bq, BQ2560X_REG_07, REG07_BATFET_DIS_MASK, val);
}
...
static int bq2560x_enter_ship_mode(struct bq2560x *bq, bool en)
{
	...
	ret = bq2560x_update_bits(bq, BQ2560X_REG_07, REG07_BATFET_DIS_MASK, val);
...
static int bq2560x_set_batfet_delay(struct bq2560x *bq, uint8_t delay)
{
	...
	return bq2560x_update_bits(bq, BQ2560X_REG_07, REG07_BATFET_DLY_MASK, val);
}
...
static int bq2560x_set_vdpm_bat_track(struct bq2560x *bq)
{
	...
	return bq2560x_update_bits(bq, BQ2560X_REG_07, REG07_VDPM_BAT_TRACK_MASK, val);
}
...
static int bq2560x_enable_safety_timer(struct bq2560x *bq)
{
	...
	return bq2560x_update_bits(bq, BQ2560X_REG_05, REG05_EN_TIMER_MASK, val);
}
...
static int bq2560x_chgdet_en(struct bq2560x *bq, bool en)
{
	...
	if (en) {
		if (oplus_vooc_get_fastchg_to_normal() == false && oplus_vooc_get_fastchg_to_warm() == false) {
			if (chip->authenticate && chip->mmi_chg && !chip->balancing_bat_stop_chg &&
			    (chip->charging_state != CHARGING_STATUS_FAIL) && oplus_vooc_get_allow_reading() &&
...
static struct bq2560x_platform_data *bq2560x_parse_dt(struct device_node *np, struct bq2560x *bq)
{
	int ret;
	struct bq2560x_platform_data *pdata;

	pdata = devm_kzalloc(bq->dev, sizeof(struct bq2560x_platform_data), GFP_KERNEL);
	if (!pdata) {
	...
	bq->chg_det_enable = of_property_read_bool(np, "ti,bq2560x,charge-detect-enable");
...
static int bq2560x_bc12_detect(struct bq2560x *bq)
{
	...
	while ((bc12_retry_num < OPLUS_BC12_RETRY_NUM) &&
	       (bq->chg_type == STANDARD_HOST || bq->chg_type == CHARGING_HOST)) {
		bc12_retry_num++;
...
#ifdef CONFIG_OPLUS_CHARGER_MTK
	if (mt6357_regmap)
		pre_vbus_status = pmic_get_register_value(mt6357_regmap, PMIC_RGS_CHRDET_ADDR, PMIC_RGS_CHRDET_MASK,
...
static void bq2560x_wakeup_vbus_status_check(unsigned int delay_ms)
{
	...
	schedule_delayed_work(&g_bq->bq2560x_check_vbus_status_work,
...
static irqreturn_t bq2560x_irq_handler(int irq, void *data)
{
	...
	if (prev_pg == bq->power_good && bq->chg_type != CHARGER_UNKNOWN && bq->chg_type != NONSTANDARD_CHARGER) {
...
static int bq2560x_register_interrupt(struct device_node *np, struct bq2560x *bq)
{
	...
	ret = devm_request_threaded_irq(bq->dev, bq->irq, NULL, bq2560x_irq_handler,
					IRQF_TRIGGER_FALLING | IRQF_ONESHOT, bq->eint_name, bq);
	if (ret < 0) {
...
int oplus_bq2560x_set_aicr(int current_ma)
{
	...
	chg_err("[BQ2560X] [current_ma:%d, chg_vol:%d, batt_volt:%d ,aicl_point:%d]\n", current_ma, chg_vol,
		chip->batt_volt, aicl_point);
	if (chip->stop_chg == 0 &&
	    ((g_bq->oplus_chg_type == POWER_SUPPLY_TYPE_USB || g_bq->oplus_chg_type == POWER_SUPPLY_TYPE_USB_CDP) ||
	     chip->mmi_chg == 0)) {
...
int oplus_bq2560x_set_input_current_limit(int current_ma)
{
	...
	if (g_oplus_chip->chg_ops->oplus_chg_get_pd_type) {
		if (g_oplus_chip->chg_ops->oplus_chg_get_pd_type() == true) {
			...
			if (rc >= 0 && ibus_ma >= PD_MIN_IBUS_MA && ibus_ma < PD_MAX_IBUS_MA && cur_ma > ibus_ma) {
				cur_ma = ibus_ma;
...
int oplus_bq2560x_charger_unsuspend(void)
{
	...
	if ((boot_mode == META_BOOT || ((oplus_get_usb_status() & USB_TEMP_HIGH) == 0)) && ((ret == 0) && (val != 0))) {
		bq2560x_exit_hiz_mode(g_bq);
	}
	...
	if (g_oplus_chip) {
		if (oplus_vooc_get_fastchg_to_normal() == false && oplus_vooc_get_fastchg_to_warm() == false) {
			if (g_oplus_chip->authenticate && g_oplus_chip->mmi_chg &&
			    ...
			    (g_oplus_chip->charging_state != CHARGING_STATUS_FAIL) && oplus_vooc_get_allow_reading() &&
			    !oplus_is_rf_ftm_mode()) {
...
static int typec_attach_thread(void *data)
{
	...
	while (!kthread_should_stop()) {
		...
		val.intval = attach;
		power_supply_set_property(bq->psy, POWER_SUPPLY_PROP_ONLINE, &val);
	}
	return ret;
}

static void handle_typec_attach(struct bq2560x *bq, bool en)
{
	mutex_lock(&bq->attach_lock);
	bq->typec_attach = en;
...
static int pd_tcp_notifier_call(struct notifier_block *nb, unsigned long event, void *data)
{
	...
	struct bq2560x *bq = (struct bq2560x *)container_of(nb, struct bq2560x, pd_nb);
...
static int bq2560x_charger_get_online(struct bq2560x *bq, bool *val)
{
	bool pwr_rdy = false;
...
static int bq2560x_charger_set_online(struct bq2560x *bq, const union power_supply_propval *val)
{
	return bq2560x_enable_chgdet(bq->chg_dev, val->intval);
}

static int bq2560x_charger_get_property(struct power_supply *psy, enum power_supply_property psp,
					union power_supply_propval *val)
{
...
static int bq2560x_charger_set_property(struct power_supply *psy, enum power_supply_property psp,
...
static int bq2560x_charger_property_is_writeable(struct power_supply *psy, enum power_supply_property psp)
{
	switch (psp) {
	case POWER_SUPPLY_PROP_ONLINE:
		return 1;
...
static char *bq2560x_charger_supplied_to[] = { "battery", "mtk-master-charger" };
#endif
...
static int bq2560x_charger_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
...
#endif
	ret = bq2560x_exit_hiz_mode(bq);
	bq2560x_update_bits(bq, BQ2560X_REG_07, REG07_BATFET_RST_EN_MASK, REG07_BATFET_RST_DISABLE);
	...
	bq->psy = devm_power_supply_register(&client->dev, &bq->psy_desc, &charger_cfg);
	if (IS_ERR_OR_NULL(bq->psy)) {
	...
	bq->chg_dev = charger_device_register(bq->chg_dev_name, &client->dev, bq, &bq2560x_chg_ops, &bq2560x_chg_props);
	...
	if (strcmp(bq->chg_dev_name, "primary_chg") == 0) {
		...
		bq->attach_task = kthread_run(typec_attach_thread, bq, "attach_thread");
		...
		ret = register_tcp_dev_notifier(bq->tcpc, &bq->pd_nb, TCP_NOTIFY_TYPE_ALL);
		if (ret < 0) {
