...
static int bq24196_input_current_limit_write(int value)
{
	...
	j = 2; /* 500 */
	rc = bq24196_config_interface(REG00_BQ24196_ADDRESS, j << REG00_BQ24196_INPUT_CURRENT_LIMIT_SHIFT,
				      REG00_BQ24196_INPUT_CURRENT_LIMIT_MASK);
	msleep(90);
...
aicl_pre_step:
	...
	chg_debug("usb input max current limit aicl chg_vol=%d j[%d]=%d sw_aicl_point:%d aicl_pre_step\n", chg_vol, j,
		  bq24196_usbin_input_current_limit[j], aicl_point_temp);
	rc = bq24196_config_interface(REG00_BQ24196_ADDRESS, j << REG00_BQ24196_INPUT_CURRENT_LIMIT_SHIFT,
				      REG00_BQ24196_INPUT_CURRENT_LIMIT_MASK);
	return rc;
aicl_end:
...
static int bq24196_input_current_limit_write(void, int value)
{
	...
	chg_debug("usb input max current limit=%d setting %02x\n", value, i);
	for (j = 2; j <= i; j++) {
		bq24196_config_interface(REG00_BQ24196_ADDRESS, j << REG00_BQ24196_INPUT_CURRENT_LIMIT_SHIFT,
					 REG00_BQ24196_INPUT_CURRENT_LIMIT_MASK);
#ifdef CONFIG_OPLUS_CHARGER_MTK
		msleep(90);
		chg_vol = battery_meter_get_charger_voltage();
		...
		if (chg_vol < chip->sw_aicl_point) {
			...
			chg_debug("usb input max current limit aicl chg_vol=%d j[%d]=%d sw_aicl_point:%d\n", chg_vol, j,
				  bq24196_usbin_input_current_limit[j], chip->sw_aicl_point);
			bq24196_config_interface(REG00_BQ24196_ADDRESS, j << REG00_BQ24196_INPUT_CURRENT_LIMIT_SHIFT,
						 REG00_BQ24196_INPUT_CURRENT_LIMIT_MASK);
			return 0;
		}
	...
	chg_debug("usb input max current limit aicl chg_vol=%d j[%d]=%d\n", chg_vol, j,
		  bq24196_usbin_input_current_limit[j]);
	rc = bq24196_config_interface(REG00_BQ24196_ADDRESS, j << REG00_BQ24196_INPUT_CURRENT_LIMIT_SHIFT,
				      REG00_BQ24196_INPUT_CURRENT_LIMIT_MASK);
	return rc;
}
...
static int bq24196_charging_current_write_fast(int chg_cur)
{
	...
	ret = bq24196_config_interface(REG02_BQ24196_ADDRESS, value,
				       REG02_BQ24196_FAST_CHARGING_CURRENT_LIMIT_MASK |
					       REG02_BQ24196_FAST_CHARGING_CURRENT_FORCE20PCT_MASK);
	return ret;
}
...
static int bq24196_set_complete_charge_timeout(int val)
{
	...
	rc = bq24196_config_interface(REG05_BQ24196_ADDRESS, val,
				      REG05_BQ24196_CHARGING_SAFETY_TIME_MASK |
					      REG05_BQ24196_FAST_CHARGING_TIMEOUT_MASK);
	if (rc < 0) {
...
int bq24196_set_prechg_current(int ipre_mA)
{
	...
	return bq24196_config_interface(REG03_BQ24196_ADDRESS, value, REG03_BQ24196_PRE_CHARGING_CURRENT_LIMIT_MASK);
}
...
static int bq24196_set_termchg_current(int term_curr)
{
	...
	bq24196_config_interface(REG03_BQ24196_ADDRESS, value, REG03_BQ24196_TERM_CHARGING_CURRENT_LIMIT_MASK);
	return rc;
}
...
static int bq24196_set_chging_term_disable(void)
{
	...
	rc = bq24196_config_interface(REG05_BQ24196_ADDRESS, REG05_BQ24196_TERMINATION_DISABLE,
				      REG05_BQ24196_TERMINATION_MASK);
...
int bq24196_kick_wdt()
{
	...
	rc = bq24196_config_interface(REG01_BQ24196_ADDRESS, REG01_BQ24196_WDT_TIMER_RESET,
				      REG01_BQ24196_WDT_TIMER_RESET_MASK);
...
int bq24196_enable_charging(void)
{
	...
	rc = bq24196_config_interface(REG01_BQ24196_ADDRESS, REG01_BQ24196_CHARGING_ENABLE,
				      REG01_BQ24196_CHARGING_MASK);
	if (rc < 0) {
...
int bq24196_disable_charging()
{
	...
	rc = bq24196_config_interface(REG01_BQ24196_ADDRESS, REG01_BQ24196_CHARGING_DISABLE,
				      REG01_BQ24196_CHARGING_MASK);
	if (rc < 0) {
...
static bool bq24196_check_charger_suspend_enable(void)
{
	...
	charger_suspend_enable =
		((reg_val & REG00_BQ24196_SUSPEND_MODE_MASK) == REG00_BQ24196_SUSPEND_MODE_ENABLE) ? true : false;
...
int bq24196_registers_read_full(void)
{
	...
	reg_full = ((reg_full & REG08_BQ24196_CHARGING_STATUS_CHARGING_MASK) ==
		    REG08_BQ24196_CHARGING_STATUS_TERM_CHARGING) ?
			   1 :
			   0;
...
#endif
	//bq24196_unsuspend_charger();
	bq24196_config_interface(REG00_BQ24196_ADDRESS, REG00_BQ24196_SUSPEND_MODE_DISABLE,
				 REG00_BQ24196_SUSPEND_MODE_MASK);

	rc = bq24196_config_interface(REG01_BQ24196_ADDRESS, REG01_BQ24196_OTG_ENABLE, REG01_BQ24196_OTG_MASK);
	if (rc) {
...
#endif
	rc = bq24196_config_interface(REG01_BQ24196_ADDRESS, REG01_BQ24196_OTG_DISABLE, REG01_BQ24196_OTG_MASK);
	if (rc)
...
int bq24196_suspend_charger(void)
{
	...
	rc = bq24196_config_interface(REG00_BQ24196_ADDRESS, REG00_BQ24196_SUSPEND_MODE_ENABLE,
				      REG00_BQ24196_SUSPEND_MODE_MASK);
	chg_debug(" rc = %d\n", rc);
	if (rc < 0) {
...
int bq24196_unsuspend_charger(void)
{
	...
	rc = bq24196_config_interface(REG00_BQ24196_ADDRESS, REG00_BQ24196_SUSPEND_MODE_DISABLE,
				      REG00_BQ24196_SUSPEND_MODE_MASK);
	chg_debug(" rc = %d\n", rc);
	if (rc < 0) {
...
int bq24196_reset_charger()
{
	...
	rc = bq24196_config_interface(REG01_BQ24196_ADDRESS, REG01_BQ24196_REGISTER_RESET,
				      REG01_BQ24196_REGISTER_RESET_MASK);
	chg_debug(" rc = %d\n", rc);
	if (rc < 0) {
...
void bq24196_dump_registers(void)
{
	...
	if (dump_count == DUMP_REG_LOG_CNT_30S) {
		dump_count = 0;
		chg_debug(
			"bq24196_reg[0-a]:0x%02x(0),0x%02x(1),0x%02x(2),0x%02x(3),0x%02x(4),0x%02x(5),0x%02x(6),0x%02x(7),0x%02x(8),0x%02x(9),0x%02x(a)\n",
...
static int bq24196_driver_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	chg_ic = devm_kzalloc(&client->dev, sizeof(struct chip_bq24196), GFP_KERNEL);
