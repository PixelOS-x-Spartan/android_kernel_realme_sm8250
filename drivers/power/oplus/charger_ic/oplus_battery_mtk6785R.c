...
static int get_charger_ntc_temp(struct thermal_zone_device *tz, int *temp)
{
	int i = 0;
	int charger_ntc_volt = 0;
...
static int mtk_charger_probe(struct platform_device *pdev)
{
	...
	if (pinfo->chargeric_temp_chan) {
		tz_dev = thermal_zone_device_register("mp2762_ntc", 0, 0, oplus_chip, &charger_ntc_thermal_zone_ops,
						      NULL, 0, 0);
