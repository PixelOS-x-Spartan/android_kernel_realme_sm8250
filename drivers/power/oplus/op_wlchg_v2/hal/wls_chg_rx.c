...
static struct oplus_wls_chg_firmware *oplus_wls_chg_find_first_firmware(void)
{
	...
	wls_firmware--;
	while (wls_firmware != NULL && wls_firmware->magic0 == OPLUS_CHG_FIRMWARE_MAGIC0 &&
...
int oplus_chg_wls_rx_register_msg_callback(struct oplus_wls_chg_rx *wls_rx, void *dev_data,
...
int oplus_chg_wls_rx_upgrade_firmware_by_img(struct oplus_wls_chg_rx *wls_rx)
{
	...
	rc = rx_ic_ops->rx_upgrade_firmware_by_img(rx_ic, oplus_wls_firmware->wls_chg_firmware,
