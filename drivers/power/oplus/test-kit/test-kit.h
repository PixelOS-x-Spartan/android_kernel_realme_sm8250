...
typedef bool (*test_kit_func_t)(struct test_feature *feature, char *buf, size_t len);
typedef bool (*test_kit_gpio_check_func_t)(void *info, char *buf, size_t len, size_t *use_size);
typedef bool (*test_kit_typec_port_check_func_t)(void *info, char *buf, size_t len, size_t *use_size);
...
inline static struct test_feature *test_feature_register(const struct test_feature_cfg *cfg, void *private_data)
{
	return NULL;
}
...
inline static bool test_kit_qcom_soc_gpio_test(struct test_feature *feature, char *buf, size_t len)
{
	return false;
}

inline static bool test_kit_mtk_soc_gpio_test(struct test_feature *feature, char *buf, size_t len)
{
	return false;
}
...
inline static bool test_kit_typec_port_test(struct test_feature *feature, char *buf, size_t len)
{
	return false;
}
