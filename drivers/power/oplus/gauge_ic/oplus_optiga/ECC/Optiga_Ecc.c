...
/* ****************************************************************************
   ...
   date:      .
 ************************************************************************* */
BOOL Ecc_GenerateCheckValue(dwordvec_t gf2n_CheckValue, dwordvec_t gf2n_RandomValue, dwordvec_t gf2n_PublicKey,
			    uint8_t bEccMode)
{
	if (bEccMode == MODE_ECCS)
...
/* ****************************************************************************
   ...
   date:      .
 ************************************************************************* */
BOOL Ecc_VerifyResponse(dwordvec_t gf2n_XResponse, dwordvec_t gf2n_ZResponse, dwordvec_t gf2n_CheckValue,
			dwordvec_t gf2n_PublicKey, uint8_t bEccMode)
{
#if defined(SLE95150) || defined(SLE95250) || defined(SLE95300)
	mac_t hostMac;
#endif
	if (bEccMode == MODE_ECCS)
		...
		return verify_mac64(gf2n_XResponse, gf2n_ZResponse, gf2n_CheckValue, gf2n_PublicKey, ECCE_131_Curve,
				    hostMac);
#endif
}
#if defined(SLE95250) || defined(SLE95300)
...
/* ****************************************************************************
   ...
   date:
 ************************************************************************* */
BOOL Ecc_StartECC(dwordvec_t gf2n_Challenge, dwordvec_t gf2n_XResponse, dwordvec_t gf2n_ZResponse, BOOL bPolling,
		  uint8_t bEccMode)
{
	BOOL ret;
#if defined(SLE95150) || defined(SLE95250) || defined(SLE95300)
	...
	ret = Ecc_SendChallengeAndGetResponse((uint16_t *)gf2n_Challenge, (uint16_t *)gf2n_XResponse,
					      (uint16_t *)gf2n_ZResponse, bPolling, bEccMode);
