...
__maybe_unused static inline int ufcs_reg_event_notifier(struct notifier_block *nb)
{
	return -EINVAL;
}

__maybe_unused static inline void ufcs_unreg_event_notifier(struct notifier_block *nb)
{
	return;
}

__maybe_unused static inline void ufcs_send_state(enum ufcs_notify_state state, void *v)
{
	return;
}
