...
#define UFCS_REQUEST_DATA(index, vol, curr)                                                                            \
	((((u64)(index) & 0xf) << 60) | ((((u64)(vol) / 10) & 0xffff) << 16) | (((u64)(curr) / 10) & 0xffff))
...
#define UFCS_SOURCE_INFO_DATA(dev_temp, usb_temp, vol, curr)                                                           \
	(((((u64)(dev_temp + 50)) & 0xff) << 40) | ((((u64)(usb_temp + 50)) & 0xff) << 32) |                           \
	 ((((u64)(vol) / 10) & 0xffff) << 16) | (((u64)(curr) / 10) & 0xffff))
...
#define UFCS_SINK_INFO_DATA(batt_temp, usb_temp, vol, curr)                                                            \
	(((((u64)(batt_temp + 50)) & 0xff) << 40) | ((((u64)(usb_temp + 50)) & 0xff) << 32) |                          \
	 ((((u64)(vol) / 10) & 0xffff) << 16) | (((u64)(curr) / 10) & 0xffff))
...
#define UFCS_CABLE_INFO_DATA(imp, vol_max, curr_max)                                                                   \
	((((u64)(imp) & 0xffff) << 16) | (((u64)(vol_max / 1000) & 0xff) << 8) | ((u64)(curr_max / 1000) & 0xff))
...
#define UFCS_DEVICE_INFO_DATA(dev_vnd, ic_vnd, hw_ver, sw_ver)                                                         \
	((((u64)(dev_vnd) & 0xffff) << 48) | (((u64)(ic_vnd) & 0xffff) << 32) | (((u64)(hw_ver) & 0xffff) << 16) |     \
	 ((u64)(sw_ver) & 0xffff))
...
#define UFCS_REFUSE_INFO_DATA(msg_index, msg_type, msg_cmd, reason)                                                    \
	((((u32)(msg_index) & 0xf) << 24) | (((u32)(msg_type) & 0x7) << 16) | (((u32)(msg_cmd) & 0xf) << 8) |          \
	 ((u32)(reason) & 0xf))
...
#define UFCS_POWER_CHANGE_DATA(index, curr_max) ((((u32)(index) & 0xf) << 20) | ((u32)(curr_max) & 0xffff))
...
#define UFCS_IS_TEST_CTRL_MSG(data) ({ (((data) & 0x3fff) == 0x3fff) ? 1 : 0; })
...
#define UFCS_OPLUS_VND_EMARK_DATA(info, hw_ver, vol_max, curr_max)                                                     \
	((((u64)(info) & 0x3) << 40) | (((u64)(hw_ver) & 0xff) << 32) | (((u64)(vol_max / 10) & 0xffff) << 16) |       \
...
#define UFCS_OPLUS_VND_POWER_INFO_DATA(index, type, vol_max, curr_max)                                                 \
	((((u64)(index) & 0x1f) << 35) | (((u64)(type) & 0x7) << 32) | (((u64)(vol_max / 10) & 0xffff) << 16) |        \
	 ((u64)(curr_max / 10) & 0xffff))
...
__maybe_unused static inline const char *ufcs_get_oplus_emark_info_str(enum ufcs_oplus_vnd_emark_info info)
{
	return "Invalid";
}

__maybe_unused static inline const char *ufcs_get_oplus_power_info_type_str(enum ufcs_oplus_vnd_power_info_type type)
{
	return "Invalid";
}
