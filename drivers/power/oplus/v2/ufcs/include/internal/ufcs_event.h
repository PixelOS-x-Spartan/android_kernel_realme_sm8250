...
int ufcs_send_data_msg_output_cap_retry(struct ufcs_class *class, struct ufcs_data_msg_output_capabilities *output_cap);
...
int ufcs_oplus_send_ctrl_msg(struct ufcs_class *class, enum ufcs_oplus_vnd_msg_type type, bool retry);
