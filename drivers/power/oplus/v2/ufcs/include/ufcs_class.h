...
struct ufcs_dev *__must_check ufcs_device_register(struct device *parent, struct ufcs_dev_ops *ops, void *drv_data,
...
__maybe_unused static inline struct ufcs_dev *__must_check ufcs_device_register(struct device *parent,
										struct ufcs_dev_ops *ops,
										void *drv_data,
										struct ufcs_config *config)
{
...
__maybe_unused static inline void ufcs_device_unregister(struct ufcs_dev *ufcs)
{
	return;
}

__maybe_unused static struct ufcs_dev *ufcs_get_ufcs_device(void)
{
	return NULL;
}

__maybe_unused static inline int ufcs_msg_handler(struct ufcs_dev *ufcs)
{
	return -EINVAL;
}

__maybe_unused static inline int ufcs_intf_pdo_set(struct ufcs_dev *ufcs, int vol_mv, int curr_ma)
{
	return -EINVAL;
}

__maybe_unused static inline int ufcs_handshake(struct ufcs_dev *ufcs)
{
	return -EINVAL;
}

__maybe_unused static inline int ufcs_source_hard_reset(struct ufcs_dev *ufcs)
{
	return -EINVAL;
}

__maybe_unused static inline int ufcs_cable_hard_reset(struct ufcs_dev *ufcs)
{
	return -EINVAL;
}

__maybe_unused static inline int ufcs_force_exit(struct ufcs_dev *ufcs)
{
	return -EINVAL;
}

__maybe_unused static inline int ufcs_intf_config_watchdog(struct ufcs_dev *ufcs, u16 time_ms)
{
	return -EINVAL;
}

__maybe_unused static inline void ufcs_clr_error_flag(struct ufcs_dev *ufcs)
{
	return;
}

__maybe_unused static inline int ufcs_set_error_flag(struct ufcs_dev *ufcs, unsigned int err_flag)
{
	return -EINVAL;
}

__maybe_unused static inline int ufcs_get_error_flag(struct ufcs_dev *ufcs, unsigned int *err_flag)
{
	return -EINVAL;
}

__maybe_unused static inline int ufcs_check_error_flag_all(struct ufcs_dev *ufcs, unsigned int *err_flag)
{
	return -EINVAL;
}

__maybe_unused static inline int ufcs_intf_get_device_info(struct ufcs_dev *ufcs, u64 *dev_info)
{
	return -EINVAL;
}

__maybe_unused static inline int ufcs_intf_get_error_info(struct ufcs_dev *ufcs, u64 *err_info)
{
	return -EINVAL;
}

__maybe_unused static inline int ufcs_intf_get_source_info(struct ufcs_dev *ufcs, u64 *src_info)
{
	return -EINVAL;
}

__maybe_unused static inline int ufcs_intf_get_cable_info(struct ufcs_dev *ufcs, u64 *cable_info)
{
	return -EINVAL;
}

__maybe_unused static inline int ufcs_intf_get_pdo_info(struct ufcs_dev *ufcs, u64 *pdo, int num)
{
	return -EINVAL;
}

__maybe_unused static inline int ufcs_intf_verify_adapter(struct ufcs_dev *ufcs, u8 key_index, u8 *auth_data,
							  u8 data_len)
{
	return -EINVAL;
}

__maybe_unused static inline int ufcs_intf_get_power_change_info(struct ufcs_dev *ufcs, u32 *pwr_change_info, int num)
{
	return -EINVAL;
}

__maybe_unused static inline int ufcs_intf_get_emark_info(struct ufcs_dev *ufcs, u64 *info)
{
	return -EINVAL;
}

__maybe_unused static inline int ufcs_intf_get_power_info_ext(struct ufcs_dev *ufcs, u64 *pie, int num)
{
	return -EINVAL;
}

__maybe_unused static inline bool ufcs_is_test_mode(struct ufcs_dev *ufcs)
{
	return false;
}

__maybe_unused static inline bool ufcs_is_vol_acc_test_mode(struct ufcs_dev *ufcs)
{
	return false;
}

__maybe_unused static inline bool ufcs_handshake_success(struct ufcs_dev *ufcs)
{
	return false;
}
