...
int ufcs_send_data_msg_output_cap(struct ufcs_class *class, struct ufcs_data_msg_output_capabilities *output_cap)
{
	ufcs_err("sink device not support send %s msg\n", ufcs_get_data_msg_name(DATA_MSG_OUTPUT_CAPABILITIES));
	return -ENOTSUPP;
}

static int __ufcs_send_data_msg_request(struct ufcs_class *class, struct ufcs_data_msg_request *request, bool retry)
{
	struct ufcs_msg *msg;
	int rc;
...
int ufcs_send_data_msg_src_info(struct ufcs_class *class, struct ufcs_data_msg_source_info *src_info)
{
	ufcs_err("sink device not support send %s msg\n", ufcs_get_data_msg_name(DATA_MSG_SOURCE_INFO));
	return -ENOTSUPP;
}

int ufcs_send_data_msg_src_info_retry(struct ufcs_class *class, struct ufcs_data_msg_source_info *src_info)
{
	ufcs_err("sink device not support send %s msg\n", ufcs_get_data_msg_name(DATA_MSG_SOURCE_INFO));
	return -ENOTSUPP;
}

static int __ufcs_send_data_msg_sink_info(struct ufcs_class *class, struct ufcs_data_msg_sink_info *sink_info,
					  bool retry)
{
	struct ufcs_msg *msg;
	int rc;
...
int ufcs_send_data_msg_sink_info(struct ufcs_class *class, struct ufcs_data_msg_sink_info *sink_info)
{
	if (class == NULL) {
		ufcs_err("class is NULL\n");
		return -EINVAL;
...
int ufcs_send_data_msg_sink_info_retry(struct ufcs_class *class, struct ufcs_data_msg_sink_info *sink_info)
{
	if (class == NULL) {
		ufcs_err("class is NULL\n");
		return -EINVAL;
...
static int __ufcs_send_data_msg_cable_info(struct ufcs_class *class, struct ufcs_data_msg_cable_info *cable_info,
					   bool retry)
{
	struct ufcs_msg *msg;
	int rc;
...
int ufcs_send_data_msg_cable_info(struct ufcs_class *class, struct ufcs_data_msg_cable_info *cable_info)
{
	if (class == NULL) {
		ufcs_err("class is NULL\n");
		return -EINVAL;
...
int ufcs_send_data_msg_cable_info_retry(struct ufcs_class *class, struct ufcs_data_msg_cable_info *cable_info)
{
	if (class == NULL) {
		ufcs_err("class is NULL\n");
		return -EINVAL;
...
static int __ufcs_send_data_msg_dev_info(struct ufcs_class *class, struct ufcs_data_msg_device_info *dev_info,
					 bool retry)
{
	struct ufcs_msg *msg;
	int rc;
...
int ufcs_send_data_msg_dev_info(struct ufcs_class *class, struct ufcs_data_msg_device_info *dev_info)
{
	if (class == NULL) {
		ufcs_err("class is NULL\n");
		return -EINVAL;
...
int ufcs_send_data_msg_dev_info_retry(struct ufcs_class *class, struct ufcs_data_msg_device_info *dev_info)
{
	if (class == NULL) {
		ufcs_err("class is NULL\n");
		return -EINVAL;
...
static int __ufcs_send_data_msg_err_info(struct ufcs_class *class, struct ufcs_data_msg_error_info *err_info,
					 bool retry)
{
	struct ufcs_msg *msg;
	int rc;
...
int ufcs_send_data_msg_err_info(struct ufcs_class *class, struct ufcs_data_msg_error_info *err_info)
{
	if (class == NULL) {
		ufcs_err("class is NULL\n");
		return -EINVAL;
...
int ufcs_send_data_msg_err_info_retry(struct ufcs_class *class, struct ufcs_data_msg_error_info *err_info)
{
	if (class == NULL) {
		ufcs_err("class is NULL\n");
		return -EINVAL;
...
static int __ufcs_send_data_msg_config_wd(struct ufcs_class *class, struct ufcs_data_msg_config_watchdog *config_wd,
					  bool retry)
{
	struct ufcs_msg *msg;
	int rc;
...
int ufcs_send_data_msg_config_wd(struct ufcs_class *class, struct ufcs_data_msg_config_watchdog *config_wd)
{
	if (class == NULL) {
		ufcs_err("class is NULL\n");
		return -EINVAL;
...
int ufcs_send_data_msg_config_wd_retry(struct ufcs_class *class, struct ufcs_data_msg_config_watchdog *config_wd)
{
	if (class == NULL) {
		ufcs_err("class is NULL\n");
		return -EINVAL;
...
static int __ufcs_send_data_msg_refuse(struct ufcs_class *class, struct ufcs_data_msg_refuse *refuse, bool retry)
{
	struct ufcs_msg *msg;
	int rc;
...
int ufcs_send_data_msg_refuse(struct ufcs_class *class, struct ufcs_msg *msg, enum ufcs_refuse_reason reason)
{
...
int ufcs_send_data_msg_refuse_retry(struct ufcs_class *class, struct ufcs_msg *msg, enum ufcs_refuse_reason reason)
{
	struct ufcs_data_msg_refuse refuse;
	u8 cmd;
					       ...
					       struct ufcs_data_msg_verify_request *verify_request, bool retry)
{
	...
	memcpy(msg->data_msg.verify_request.random_data, verify_request->random_data, UFCS_VERIFY_RANDOM_DATA_SIZE);
...
int ufcs_send_data_msg_verify_request(struct ufcs_class *class, struct ufcs_data_msg_verify_request *verify_request)
{
	if (class == NULL) {
		ufcs_err("class is NULL\n");
		return -EINVAL;
						...
						struct ufcs_data_msg_verify_response *verify_response, bool retry)
{
	...
	memcpy(msg->data_msg.verify_response.random_data, verify_response->random_data, UFCS_VERIFY_RANDOM_DATA_SIZE);
...
int ufcs_send_data_msg_verify_response(struct ufcs_class *class, struct ufcs_data_msg_verify_response *verify_response)
{
	if (class == NULL) {
		ufcs_err("class is NULL\n");
		return -EINVAL;
...
int ufcs_send_data_msg_power_change(struct ufcs_class *class, struct ufcs_data_msg_power_change *power_change)
{
	ufcs_err("sink device not support send %s msg\n", ufcs_get_data_msg_name(DATA_MSG_POWER_CHANGE));
	return -ENOTSUPP;
}

int ufcs_send_data_msg_power_change_retry(struct ufcs_class *class, struct ufcs_data_msg_power_change *power_change)
{
	ufcs_err("sink device not support send %s msg\n", ufcs_get_data_msg_name(DATA_MSG_POWER_CHANGE));
	return -ENOTSUPP;
}

int ufcs_send_data_msg_test_request(struct ufcs_class *class, struct ufcs_data_msg_test_request *test_request)
{
	ufcs_err("sink device not support send %s msg\n", ufcs_get_data_msg_name(DATA_MSG_TEST_REQUEST));
	return -ENOTSUPP;
}

int ufcs_send_data_msg_test_request_retry(struct ufcs_class *class, struct ufcs_data_msg_test_request *test_request)
{
	ufcs_err("sink device not support send %s msg\n", ufcs_get_data_msg_name(DATA_MSG_TEST_REQUEST));
	return -ENOTSUPP;
}
