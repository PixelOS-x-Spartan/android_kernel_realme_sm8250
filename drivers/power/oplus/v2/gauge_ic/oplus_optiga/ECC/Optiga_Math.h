...
#define BIG_U8TO32(c)                                                                                                  \
	(((uint32_t)T8(*(c)) << 24) | ((uint32_t)T8(*((c) + 1)) << 16) | ((uint32_t)T8(*((c) + 2)) << 8) |             \
	 ((uint32_t)T8(*((c) + 3))))

/** conversion word to character string big endian */
#define BIG_U32TO8(c, v)                                                                                               \
	do {                                                                                                           \
...
BOOL verify_mac80(const mac_t mac_value, const dwordvec_t Z, const dwordvec_t xC, const mac_t data,
