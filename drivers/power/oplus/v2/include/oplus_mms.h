...
struct mms_msg *oplus_mms_alloc_str_msg(enum mms_msg_type type, enum mms_msg_prio prio, u32 item_id, const char *format,
					...);
...
int oplus_mms_analysis_ic_err_msg(char *buf, size_t buf_size, int *name_index, int *type, int *sub_type,
				  int *msg_index);
struct mms_subscribe *oplus_mms_subscribe(struct oplus_mms *mms, void *priv_data,
					  void (*callback)(struct mms_subscribe *, enum mms_msg_type, u32),
					  const char *format, ...);
