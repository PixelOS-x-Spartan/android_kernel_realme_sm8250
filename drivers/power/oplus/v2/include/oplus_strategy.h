...
struct oplus_chg_strategy_desc {
	...
	struct oplus_chg_strategy *(*strategy_alloc)(unsigned char *buf, size_t size);
...
struct oplus_chg_strategy *oplus_chg_strategy_alloc(const char *name, unsigned char *buf, size_t size);
struct oplus_chg_strategy *oplus_chg_strategy_alloc_by_node(const char *name, struct device_node *node);
...
int oplus_chg_strategy_read_data(struct device *dev, const char *prop_str, uint8_t **buf);
