...
enum vooc_curr_table_type { VOOC_CURR_TABLE_OLD_1_0 = 0, VOOC_CURR_TABLE_1_0, VOOC_CURR_TABLE_2_0, VOOC_CP_CURR_TABLE };
...
#define adapter_info_to_sid(id, power, adapter_type, adapter_chg_type)                                                 \
	((((id) & 0xff) << 24) | (((power) & 0xffff) << 8) | (((adapter_type) & 0xf) << 4) | ((adapter_chg_type) & 0xf))
