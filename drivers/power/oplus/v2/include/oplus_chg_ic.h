...
#define OPLUS_CHG_IC_FUNC_DEF(func_id) typedef int(*func_id##_T)

#define oplus_chg_ic_func(ic, func_id, ...)                                                                            \
	({                                                                                                             \
		func_id##_T _func = (ic && ic->get_func) ? ic->get_func(ic, func_id) : NULL;                           \
...
#define oplus_print_ic_err(msg)                                                                                        \
	chg_err("[IC_ERR][%s]-[%s]:%s\n", msg->ic->name, oplus_chg_ic_err_text(msg->type), msg->msg);
...
int oplus_chg_ic_creat_err_msg(struct oplus_chg_ic_dev *ic_dev, enum oplus_chg_ic_err err_type, int sub_err_type,
			       const char *format, ...);
