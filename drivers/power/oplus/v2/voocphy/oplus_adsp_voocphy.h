...
typedef enum _FASTCHG_STATUS {
	...
	ADSP_VPHY_FAST_NOTIFY_CRASH,
} FASTCHG_STATUS;

#if IS_ENABLED(CONFIG_OPLUS_CHG_ADSP_VOOCPHY)
void oplus_adsp_voocphy_fastchg_event_handle(int event);
void oplus_adsp_voocphy_reset_status(void);
#else
static inline void oplus_adsp_voocphy_fastchg_event_handle(int event)
{
}

static inline void oplus_adsp_voocphy_reset_status(void)
{
}
#endif /* CONFIG_OPLUS_CHG_ADSP_VOOCPHY*/
#endif /* _OPLUS_ADSP_VOOCPHY_H_ */
