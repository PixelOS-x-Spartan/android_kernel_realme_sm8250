...
static void oplus_comm_update_temp_region_config(struct oplus_param_head *param_head,
...
static void oplus_comm_update_iterm_config(struct oplus_param_head *param_head, struct oplus_comm_spec_config *spec)
{
	struct oplus_cfg_data_head *data_head;
	int32_t buf;
	int rc;
...
static void oplus_comm_update_fv_config(struct oplus_param_head *param_head, struct oplus_comm_spec_config *spec)
{
	struct oplus_cfg_data_head *data_head;
...
static void oplus_comm_update_rechg_config(struct oplus_param_head *param_head, struct oplus_comm_spec_config *spec)
{
	struct oplus_cfg_data_head *data_head;
	int32_t buf[TEMP_REGION_MAX];
	int i, rc;
...
static void oplus_comm_update_misc_config(struct oplus_param_head *param_head, struct oplus_comm_spec_config *spec)
{
	struct oplus_cfg_data_head *data_head;
	int32_t buf;
	int rc;
...
static void oplus_comm_update_ffc_config(struct oplus_param_head *param_head, struct oplus_comm_spec_config *spec)
{
...
static void oplus_comm_update_ui_soc_config(struct oplus_param_head *param_head, struct oplus_comm_config *config)
{
	struct oplus_cfg_data_head *data_head;
	u8 enable;
	int32_t buf;
...
static void oplus_comm_update_smooth_soc_config(struct oplus_param_head *param_head, struct oplus_comm_config *config)
{
	struct oplus_cfg_data_head *data_head;
	u8 enable;
	int32_t buf;
