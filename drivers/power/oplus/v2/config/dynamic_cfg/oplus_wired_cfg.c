...
static void oplus_wired_update_input_power_config(struct oplus_param_head *param_head,
...
static void oplus_wired_update_fcc_config(struct oplus_param_head *param_head, struct oplus_wired_spec_config *spec)
{
	struct oplus_cfg_data_head *data_head;
...
static void oplus_wired_update_cool_down_config(struct oplus_param_head *param_head,
						struct oplus_wired_spec_config *spec)
{
	struct oplus_cfg_data_head *data_head;
...
static void oplus_wired_update_vbus_ov_uv_config(struct oplus_param_head *param_head,
						 struct oplus_wired_spec_config *spec)
{
	struct oplus_cfg_data_head *data_head;
...
static void oplus_wired_update_vooc_strategy_config(struct oplus_param_head *param_head,
