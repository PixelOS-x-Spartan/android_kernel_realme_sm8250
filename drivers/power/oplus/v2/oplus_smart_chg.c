...
__maybe_unused static bool is_vooc_curr_votable_available(struct oplus_smart_charge *chip)
{
...
static void oplus_smart_chg_quick_mode_check(struct oplus_smart_charge *smart_chg)
{
	...
	if (smart_chg->vooc_online && smart_chg->quick_mode_gain_support &&
...
{
	struct oplus_smart_charge *smart_chg = container_of(work, struct oplus_smart_charge, quick_mode_check_work);
...
static void oplus_smart_chg_vooc_subs_callback(struct mms_subscribe *subs, enum mms_msg_type type, u32 id)
{
...
static void oplus_smart_chg_subscribe_vooc_topic(struct oplus_mms *topic, void *prv_data)
{
	...
	smart_chg->vooc_subs =
		oplus_mms_subscribe(smart_chg->vooc_topic, smart_chg, oplus_smart_chg_vooc_subs_callback, "smart_chg");
...
static void oplus_smart_chg_gauge_subs_callback(struct mms_subscribe *subs, enum mms_msg_type type, u32 id)
{
	struct oplus_smart_charge *smart_chg = subs->priv_data;
...
static void oplus_smart_chg_subscribe_gauge_topic(struct oplus_mms *topic, void *prv_data)
{
	struct oplus_smart_charge *smart_chg = prv_data;
	union mms_msg_data data = { 0 };

	smart_chg->gauge_topic = topic;
	smart_chg->gauge_subs = oplus_mms_subscribe(smart_chg->gauge_topic, smart_chg,
...
static void oplus_smart_chg_wired_subs_callback(struct mms_subscribe *subs, enum mms_msg_type type, u32 id)
{
	struct oplus_smart_charge *smart_chg = subs->priv_data;
	union mms_msg_data data = { 0 };
...
static void oplus_smart_chg_subscribe_wired_topic(struct oplus_mms *topic, void *prv_data)
{
	struct oplus_smart_charge *smart_chg = prv_data;
	union mms_msg_data data = { 0 };

	smart_chg->wired_topic = topic;
	smart_chg->wired_subs = oplus_mms_subscribe(smart_chg->wired_topic, smart_chg,
...
static void oplus_smart_chg_ufcs_subs_callback(struct mms_subscribe *subs, enum mms_msg_type type, u32 id)
{
	struct oplus_smart_charge *smart_chg = subs->priv_data;
	union mms_msg_data data = { 0 };
...
static void oplus_smart_chg_subscribe_ufcs_topic(struct oplus_mms *topic, void *prv_data)
{
	struct oplus_smart_charge *smart_chg = prv_data;
	union mms_msg_data data = { 0 };
	int rc;
	...
	smart_chg->ufcs_subs =
		oplus_mms_subscribe(smart_chg->ufcs_topic, smart_chg, oplus_smart_chg_ufcs_subs_callback, "smart_chg");
...
static void oplus_smart_chg_wls_subs_callback(struct mms_subscribe *subs, enum mms_msg_type type, u32 id)
{
	struct oplus_smart_charge *smart_chg = subs->priv_data;
	union mms_msg_data data = { 0 };
...
static void oplus_smart_chg_subscribe_wls_topic(struct oplus_mms *topic, void *prv_data)
{
	struct oplus_smart_charge *smart_chg = prv_data;

	smart_chg->wls_topic = topic;
	smart_chg->wls_subs =
		oplus_mms_subscribe(smart_chg->wls_topic, smart_chg, oplus_smart_chg_wls_subs_callback, "smart_chg");
...
static void oplus_smart_chg_common_topic_ready(struct oplus_mms *topic, void *prv_data)
{
	struct oplus_smart_charge *smart_chg = prv_data;
	union mms_msg_data data = { 0 };
...
static int oplus_smart_charge_parse_dt(struct oplus_smart_charge *smart_chg)
{
	...
	smart_chg->smart_chg_soh_support = of_property_read_bool(node, "oplus,smart_chg_soh_support");
	smart_chg->quick_mode_gain_support = of_property_read_bool(node, "oplus,quick_mode_gain_support");
...
int oplus_smart_chg_get_battery_bcc_parameters(char *buf)
{
	...
	if ((vooc_get_fastchg_ing && vooc_get_fast_chg_type != BCC_TYPE_IS_VOOC) || voocphy_get_fastchg_ing ||
	    g_smart_chg->ufcs_charging || wls_fastchg_charging) {
		buffer[15] = 1;
	} else {
		buffer[15] = 0;
	}
	...
	if (voocphy_get_fastchg_ing || (vooc_get_fastchg_ing && (vooc_get_fast_chg_type != BCC_TYPE_IS_VOOC))) {
...
int oplus_smart_chg_get_prev_battery_bcc_parameters(char *buf)
{
	...
	chg_info("bcc_voocphy buf:%d,%d,%d,%d\n", vooc_get_fastchg_ing, vooc_get_fast_chg_type,
		 vooc_check_bcc_temp_range, voocphy_get_fastchg_ing);
...
long oplus_smart_chg_get_quick_mode_time_gain(void)
{
	...
	chg_info("total_time:%ld, gain_time:%ld, quick_mode_gain_time_ms:%ld\n", total_time, gain_time,
		 g_smart_chg->quick_mode_gain_time_ms);
